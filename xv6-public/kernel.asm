...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 e7 84 10 80 	movl   $0x801084e7,(%esp)
...
80102088:	68 72 82 10 80       	push   $0x80108272
...
801024d2:	81 fb d0 b5 11 80    	cmp    $0x8011b5d0,%ebx
...
80103077:	68 d0 b5 11 80       	push   $0x8011b5d0
...
801037cf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d0:	81 c3 c0 01 00 00    	add    $0x1c0,%ebx
801037d6:	81 fb 54 9d 11 80    	cmp    $0x80119d54,%ebx
...
8010382b:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382e:	c7 40 14 bf 59 10 80 	movl   $0x801059bf,0x14(%eax)
  p->context = (struct context*)sp;
...
8010384f:	89 d8                	mov    %ebx,%eax
  p->num_mappings = 0;
80103851:	c7 83 bc 01 00 00 00 	movl   $0x0,0x1bc(%ebx)
80103858:	00 00 00 
}
...
801038e6:	68 60 80 10 80       	push   $0x80108060
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 54 9d 11 80       	mov    %eax,0x80119d54
...
80103a4f:	68 90 80 10 80       	push   $0x80108090
80103a54:	50                   	push   %eax
80103a55:	e8 d6 0d 00 00       	call   80104830 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 99 80 10 80 	movl   $0x80108099,(%esp)
...
80103a93:	68 77 80 10 80       	push   $0x80108077
...
80103ca2:	e8 e4 0b 00 00       	call   8010488b <swtch>
      switchkvm();
80103ca7:	e8 54 2f 00 00       	call   80106c00 <switchkvm>
      c->proc = 0;
80103cac:	83 c4 10             	add    $0x10,%esp
80103caf:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103cb6:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb9:	81 c3 c0 01 00 00    	add    $0x1c0,%ebx
80103cbf:	81 fb 54 9d 11 80    	cmp    $0x80119d54,%ebx
...
80103da9:	e8 d2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dae:	39 05 54 9d 11 80    	cmp    %eax,0x80119d54
...
80103e20:	05 c0 01 00 00       	add    $0x1c0,%eax
80103e25:	3d 54 9d 11 80       	cmp    $0x80119d54,%eax
...
80103e37:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e3e:	05 c0 01 00 00       	add    $0x1c0,%eax
80103e43:	3d 54 9d 11 80       	cmp    $0x80119d54,%eax
80103e48:	75 e2                	jne    80103e2c <exit+0x8c>
      p->parent = initproc;
80103e4a:	8b 0d 54 9d 11 80    	mov    0x80119d54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e60:	81 c2 c0 01 00 00    	add    $0x1c0,%edx
80103e66:	81 fa 54 9d 11 80    	cmp    $0x80119d54,%edx
...
80103e87:	90                   	nop
80103e88:	05 c0 01 00 00       	add    $0x1c0,%eax
80103e8d:	3d 54 9d 11 80       	cmp    $0x80119d54,%eax
...
80103eb7:	68 e8 80 10 80       	push   $0x801080e8
80103ebc:	e8 bf c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ec1:	83 ec 0c             	sub    $0xc,%esp
80103ec4:	68 db 80 10 80       	push   $0x801080db
...
80103f07:	90                   	nop
80103f08:	81 c3 c0 01 00 00    	add    $0x1c0,%ebx
80103f0e:	81 fb 54 9d 11 80    	cmp    $0x80119d54,%ebx
...
80103f1f:	74 5f                	je     80103f80 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f21:	81 c3 c0 01 00 00    	add    $0x1c0,%ebx
      havekids = 1;
80103f27:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f2c:	81 fb 54 9d 11 80    	cmp    $0x80119d54,%ebx
...
80103f99:	e8 52 30 00 00       	call   80106ff0 <freevm>
        p->pid = 0;
...
80103ff0:	68 f4 80 10 80       	push   $0x801080f4
...
801040f9:	68 fa 80 10 80       	push   $0x801080fa
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 f4 80 10 80       	push   $0x801080f4
...
80104130:	05 c0 01 00 00       	add    $0x1c0,%eax
80104135:	3d 54 9d 11 80       	cmp    $0x80119d54,%eax
...
80104147:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010414e:	05 c0 01 00 00       	add    $0x1c0,%eax
80104153:	3d 54 9d 11 80       	cmp    $0x80119d54,%eax
...
80104190:	05 c0 01 00 00       	add    $0x1c0,%eax
80104195:	3d 54 9d 11 80       	cmp    $0x80119d54,%eax
...
8010420b:	68 e7 84 10 80       	push   $0x801084e7
80104210:	e8 8b c4 ff ff       	call   801006a0 <cprintf>
80104215:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104218:	81 c3 c0 01 00 00    	add    $0x1c0,%ebx
8010421e:	81 fb c0 9d 11 80    	cmp    $0x80119dc0,%ebx
...
8010422f:	74 e7                	je     80104218 <procdump+0x28>
      state = "???";
80104231:	ba 0b 81 10 80       	mov    $0x8010810b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104236:	83 f8 05             	cmp    $0x5,%eax
80104239:	77 11                	ja     8010424c <procdump+0x5c>
8010423b:	8b 14 85 6c 81 10 80 	mov    -0x7fef7e94(,%eax,4),%edx
      state = "???";
80104242:	b8 0b 81 10 80       	mov    $0x8010810b,%eax
...
80104251:	68 0f 81 10 80       	push   $0x8010810f
...
8010428d:	68 61 7b 10 80       	push   $0x80107b61
...
801042ba:	68 84 81 10 80       	push   $0x80108184
...
801044f5:	68 8f 81 10 80       	push   $0x8010818f
801044fa:	e8 81 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ff:	83 ec 0c             	sub    $0xc,%esp
80104502:	68 a6 81 10 80       	push   $0x801081a6
...
8010456b:	68 ad 81 10 80       	push   $0x801081ad
...
80104660:	68 b5 81 10 80       	push   $0x801081b5
...
80104a8c:	8b 14 85 e0 81 10 80 	mov    -0x7fef7e20(,%eax,4),%edx
...
80104ab8:	68 bd 81 10 80       	push   $0x801081bd
...
80104c14:	68 68 82 10 80       	push   $0x80108268
...
80104c2c:	68 67 82 10 80       	push   $0x80108267
...
80104c41:	68 5b 82 10 80       	push   $0x8010825b
...
80104c5f:	68 6a 82 10 80       	push   $0x8010826a
80104c64:	e8 17 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c69:	83 ec 0c             	sub    $0xc,%esp
80104c6c:	68 4c 82 10 80       	push   $0x8010824c
...
8010506d:	58                   	pop    %eax
8010506e:	5a                   	pop    %edx
8010506f:	68 68 82 10 80       	push   $0x80108268
...
80105088:	68 67 82 10 80       	push   $0x80108267
...
80105790:	68 80 9d 11 80       	push   $0x80119d80
80105795:	e8 16 ee ff ff       	call   801045b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010579a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010579d:	8b 1d 60 9d 11 80    	mov    0x80119d60,%ebx
  while(ticks - ticks0 < n){
...
801057b3:	68 80 9d 11 80       	push   $0x80119d80
801057b8:	68 60 9d 11 80       	push   $0x80119d60
801057bd:	e8 8e e8 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
801057c2:	a1 60 9d 11 80       	mov    0x80119d60,%eax
...
80105824:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105827:	68 80 9d 11 80       	push   $0x80119d80
8010582c:	e8 7f ed ff ff       	call   801045b0 <acquire>
  xticks = ticks;
80105831:	8b 1d 60 9d 11 80    	mov    0x80119d60,%ebx
  release(&tickslock);
80105837:	c7 04 24 80 9d 11 80 	movl   $0x80119d80,(%esp)
...
801058f6:	78 18                	js     80105910 <sys_wunmap+0x30>
    return FAILED;
  }
  return wunmap(addr);
801058f8:	83 ec 0c             	sub    $0xc,%esp
801058fb:	ff 75 f4             	push   -0xc(%ebp)
801058fe:	e8 8d 1d 00 00       	call   80107690 <wunmap>
...
8010593e:	e8 3d f0 ff ff       	call   80104980 <argptr>
80105943:	83 c4 10             	add    $0x10,%esp
80105946:	85 c0                	test   %eax,%eax
80105948:	78 16                	js     80105960 <sys_getpgdirinfo+0x30>
    return FAILED;
  }
  return getpgdirinfo(pdinfo);
8010594a:	83 ec 0c             	sub    $0xc,%esp
8010594d:	ff 75 f4             	push   -0xc(%ebp)
80105950:	e8 8b 1f 00 00       	call   801078e0 <getpgdirinfo>
...
8010597e:	e8 fd ef ff ff       	call   80104980 <argptr>
80105983:	83 c4 10             	add    $0x10,%esp
80105986:	85 c0                	test   %eax,%eax
80105988:	78 16                	js     801059a0 <sys_getwmapinfo+0x30>
    return FAILED;
  }
  return getwmapinfo(wminfo);
8010598a:	83 ec 0c             	sub    $0xc,%esp
8010598d:	ff 75 f4             	push   -0xc(%ebp)
80105990:	e8 cb 1f 00 00       	call   80107960 <getwmapinfo>
...
801059e7:	c7 04 c5 c2 9d 11 80 	movl   $0x8e000008,-0x7fee623e(,%eax,8)
801059ee:	08 00 00 8e 
801059f2:	66 89 14 c5 c0 9d 11 	mov    %dx,-0x7fee6240(,%eax,8)
801059f9:	80 
801059fa:	c1 ea 10             	shr    $0x10,%edx
801059fd:	66 89 14 c5 c6 9d 11 	mov    %dx,-0x7fee623a(,%eax,8)
80105a04:	80 
  for(i = 0; i < 256; i++)
...
80105a0f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a12:	a1 08 b1 10 80       	mov    0x8010b108,%eax
80105a17:	c7 05 c2 9f 11 80 08 	movl   $0xef000008,0x80119fc2
80105a1e:	00 00 ef 
  initlock(&tickslock, "time");
80105a21:	68 ad 82 10 80       	push   $0x801082ad
80105a26:	68 80 9d 11 80       	push   $0x80119d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a2b:	66 a3 c0 9f 11 80    	mov    %ax,0x80119fc0
80105a31:	c1 e8 10             	shr    $0x10,%eax
80105a34:	66 a3 c6 9f 11 80    	mov    %ax,0x80119fc6
  initlock(&tickslock, "time");
...
80105a5b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a5f:	b8 c0 9d 11 80       	mov    $0x80119dc0,%eax
...
80105a92:	0f 84 30 01 00 00    	je     80105bc8 <trap+0x148>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105aa4:	ff 24 85 68 83 10 80 	jmp    *-0x7fef7c98(,%eax,4)
...
80105ab7:	0f 84 23 02 00 00    	je     80105ce0 <trap+0x260>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105abd:	e8 4e ce ff ff       	call   80102910 <lapiceoi>
  }
...
80105ac9:	74 1d                	je     80105ae8 <trap+0x68>
80105acb:	e8 b0 de ff ff       	call   80103980 <myproc>
80105ad0:	8b 50 24             	mov    0x24(%eax),%edx
80105ad3:	85 d2                	test   %edx,%edx
80105ad5:	74 11                	je     80105ae8 <trap+0x68>
80105ad7:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105adb:	83 e0 03             	and    $0x3,%eax
80105ade:	66 83 f8 03          	cmp    $0x3,%ax
80105ae2:	0f 84 d8 01 00 00    	je     80105cc0 <trap+0x240>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105ae8:	e8 93 de ff ff       	call   80103980 <myproc>
80105aed:	85 c0                	test   %eax,%eax
80105aef:	74 0f                	je     80105b00 <trap+0x80>
80105af1:	e8 8a de ff ff       	call   80103980 <myproc>
80105af6:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105afa:	0f 84 b0 00 00 00    	je     80105bb0 <trap+0x130>
...
80105b07:	74 1d                	je     80105b26 <trap+0xa6>
80105b09:	e8 72 de ff ff       	call   80103980 <myproc>
80105b0e:	8b 40 24             	mov    0x24(%eax),%eax
80105b11:	85 c0                	test   %eax,%eax
80105b13:	74 11                	je     80105b26 <trap+0xa6>
80105b15:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105b19:	83 e0 03             	and    $0x3,%eax
80105b1c:	66 83 f8 03          	cmp    $0x3,%ax
80105b20:	0f 84 cf 00 00 00    	je     80105bf5 <trap+0x175>
    exit();
}
80105b26:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105b29:	5b                   	pop    %ebx
80105b2a:	5e                   	pop    %esi
80105b2b:	5f                   	pop    %edi
80105b2c:	5d                   	pop    %ebp
...
80105b30:	e8 4b de ff ff       	call   80103980 <myproc>
80105b35:	8b 7b 38             	mov    0x38(%ebx),%edi
80105b38:	85 c0                	test   %eax,%eax
80105b3a:	0f 84 d4 01 00 00    	je     80105d14 <trap+0x294>
80105b40:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105b44:	0f 84 ca 01 00 00    	je     80105d14 <trap+0x294>
...
80105b50:	e8 0b de ff ff       	call   80103960 <cpuid>
...
80105b85:	68 24 83 10 80       	push   $0x80108324
80105b8a:	e8 11 ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105b8f:	83 c4 20             	add    $0x20,%esp
80105b92:	e8 e9 dd ff ff       	call   80103980 <myproc>
80105b97:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b9e:	e8 dd dd ff ff       	call   80103980 <myproc>
80105ba3:	85 c0                	test   %eax,%eax
80105ba5:	0f 85 20 ff ff ff    	jne    80105acb <trap+0x4b>
80105bab:	e9 38 ff ff ff       	jmp    80105ae8 <trap+0x68>
  if(myproc() && myproc()->state == RUNNING &&
80105bb0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105bb4:	0f 85 46 ff ff ff    	jne    80105b00 <trap+0x80>
    yield();
80105bba:	e8 41 e4 ff ff       	call   80104000 <yield>
80105bbf:	e9 3c ff ff ff       	jmp    80105b00 <trap+0x80>
...
80105bd2:	0f 85 f8 00 00 00    	jne    80105cd0 <trap+0x250>
    myproc()->tf = tf;
80105bd8:	e8 a3 dd ff ff       	call   80103980 <myproc>
80105bdd:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105be0:	e8 8b ee ff ff       	call   80104a70 <syscall>
    if(myproc()->killed)
80105be5:	e8 96 dd ff ff       	call   80103980 <myproc>
80105bea:	8b 48 24             	mov    0x24(%eax),%ecx
80105bed:	85 c9                	test   %ecx,%ecx
80105bef:	0f 84 31 ff ff ff    	je     80105b26 <trap+0xa6>
}
80105bf5:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105bf8:	5b                   	pop    %ebx
80105bf9:	5e                   	pop    %esi
80105bfa:	5f                   	pop    %edi
80105bfb:	5d                   	pop    %ebp
      exit();
80105bfc:	e9 9f e1 ff ff       	jmp    80103da0 <exit>
80105c01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105c08:	0f 20 d0             	mov    %cr2,%eax
    if (handle_pagefault(failed_addr)) {
80105c0b:	83 ec 0c             	sub    $0xc,%esp
    uint failed_addr = PGROUNDDOWN(rcr2());
80105c0e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (handle_pagefault(failed_addr)) {
80105c13:	50                   	push   %eax
80105c14:	e8 97 1d 00 00       	call   801079b0 <handle_pagefault>
80105c19:	83 c4 10             	add    $0x10,%esp
80105c1c:	85 c0                	test   %eax,%eax
80105c1e:	0f 85 9e fe ff ff    	jne    80105ac2 <trap+0x42>
      cprintf("Segmentation Fault\n");
80105c24:	83 ec 0c             	sub    $0xc,%esp
80105c27:	68 b2 82 10 80       	push   $0x801082b2
80105c2c:	e8 6f aa ff ff       	call   801006a0 <cprintf>
      exit();
80105c31:	e8 6a e1 ff ff       	call   80103da0 <exit>
80105c36:	83 c4 10             	add    $0x10,%esp
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105c39:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c3c:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105c40:	e8 1b dd ff ff       	call   80103960 <cpuid>
80105c45:	57                   	push   %edi
80105c46:	56                   	push   %esi
80105c47:	50                   	push   %eax
80105c48:	68 cc 82 10 80       	push   $0x801082cc
80105c4d:	e8 4e aa ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105c52:	e8 b9 cc ff ff       	call   80102910 <lapiceoi>
    break;
80105c57:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c5a:	e8 21 dd ff ff       	call   80103980 <myproc>
80105c5f:	85 c0                	test   %eax,%eax
80105c61:	0f 85 64 fe ff ff    	jne    80105acb <trap+0x4b>
80105c67:	e9 7c fe ff ff       	jmp    80105ae8 <trap+0x68>
...
80105c81:	0f 85 44 fe ff ff    	jne    80105acb <trap+0x4b>
80105c87:	e9 5c fe ff ff       	jmp    80105ae8 <trap+0x68>
...
80105ca1:	0f 85 24 fe ff ff    	jne    80105acb <trap+0x4b>
80105ca7:	e9 3c fe ff ff       	jmp    80105ae8 <trap+0x68>
80105cac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105cb0:	e8 8b c5 ff ff       	call   80102240 <ideintr>
80105cb5:	e9 03 fe ff ff       	jmp    80105abd <trap+0x3d>
80105cba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105cc0:	e8 db e0 ff ff       	call   80103da0 <exit>
80105cc5:	e9 1e fe ff ff       	jmp    80105ae8 <trap+0x68>
80105cca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105cd0:	e8 cb e0 ff ff       	call   80103da0 <exit>
80105cd5:	e9 fe fe ff ff       	jmp    80105bd8 <trap+0x158>
80105cda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105ce0:	83 ec 0c             	sub    $0xc,%esp
80105ce3:	68 80 9d 11 80       	push   $0x80119d80
80105ce8:	e8 c3 e8 ff ff       	call   801045b0 <acquire>
      wakeup(&ticks);
80105ced:	c7 04 24 60 9d 11 80 	movl   $0x80119d60,(%esp)
      ticks++;
80105cf4:	83 05 60 9d 11 80 01 	addl   $0x1,0x80119d60
      wakeup(&ticks);
80105cfb:	e8 10 e4 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105d00:	c7 04 24 80 9d 11 80 	movl   $0x80119d80,(%esp)
80105d07:	e8 44 e8 ff ff       	call   80104550 <release>
80105d0c:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105d0f:	e9 a9 fd ff ff       	jmp    80105abd <trap+0x3d>
80105d14:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d17:	e8 44 dc ff ff       	call   80103960 <cpuid>
80105d1c:	83 ec 0c             	sub    $0xc,%esp
80105d1f:	56                   	push   %esi
80105d20:	57                   	push   %edi
80105d21:	50                   	push   %eax
80105d22:	ff 73 30             	push   0x30(%ebx)
80105d25:	68 f0 82 10 80       	push   $0x801082f0
80105d2a:	e8 71 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105d2f:	83 c4 14             	add    $0x14,%esp
80105d32:	68 c6 82 10 80       	push   $0x801082c6
80105d37:	e8 44 a6 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80105d40:	a1 c0 a5 11 80       	mov    0x8011a5c0,%eax
...
80105dc7:	74 78                	je     80105e41 <uartinit+0xd1>
  uart = 1;
80105dc9:	c7 05 c0 a5 11 80 01 	movl   $0x1,0x8011a5c0
80105dd0:	00 00 00 
...
80105ddc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ddf:	bf 30 84 10 80       	mov    $0x80108430,%edi
...
80105df9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e00:	a1 c0 a5 11 80       	mov    0x8011a5c0,%eax
...
80105e50 <uartputc>:
  if(!uart)
80105e50:	a1 c0 a5 11 80       	mov    0x8011a5c0,%eax
...
80105ec7:	6a 00                	push   $0x0
  jmp alltraps
80105ec9:	e9 d9 fa ff ff       	jmp    801059a7 <alltraps>
...
80105ed0:	6a 01                	push   $0x1
  jmp alltraps
80105ed2:	e9 d0 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f06:	6a 07                	push   $0x7
  jmp alltraps
80105f08:	e9 9a fa ff ff       	jmp    801059a7 <alltraps>
...
80105f1d:	6a 0a                	push   $0xa
  jmp alltraps
80105f1f:	e9 83 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f24:	6a 0b                	push   $0xb
  jmp alltraps
80105f26:	e9 7c fa ff ff       	jmp    801059a7 <alltraps>
...
80105f39:	6a 0e                	push   $0xe
  jmp alltraps
80105f3b:	e9 67 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f42:	6a 0f                	push   $0xf
  jmp alltraps
80105f44:	e9 5e fa ff ff       	jmp    801059a7 <alltraps>
...
80105f4b:	6a 10                	push   $0x10
  jmp alltraps
80105f4d:	e9 55 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f52:	6a 11                	push   $0x11
  jmp alltraps
80105f54:	e9 4e fa ff ff       	jmp    801059a7 <alltraps>
...
80105f5b:	6a 12                	push   $0x12
  jmp alltraps
80105f5d:	e9 45 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f64:	6a 13                	push   $0x13
  jmp alltraps
80105f66:	e9 3c fa ff ff       	jmp    801059a7 <alltraps>
...
80105f6d:	6a 14                	push   $0x14
  jmp alltraps
80105f6f:	e9 33 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f76:	6a 15                	push   $0x15
  jmp alltraps
80105f78:	e9 2a fa ff ff       	jmp    801059a7 <alltraps>
...
80105f7f:	6a 16                	push   $0x16
  jmp alltraps
80105f81:	e9 21 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f88:	6a 17                	push   $0x17
  jmp alltraps
80105f8a:	e9 18 fa ff ff       	jmp    801059a7 <alltraps>
...
80105f91:	6a 18                	push   $0x18
  jmp alltraps
80105f93:	e9 0f fa ff ff       	jmp    801059a7 <alltraps>
...
80105f9a:	6a 19                	push   $0x19
  jmp alltraps
80105f9c:	e9 06 fa ff ff       	jmp    801059a7 <alltraps>
...
80105fa3:	6a 1a                	push   $0x1a
  jmp alltraps
80105fa5:	e9 fd f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fac:	6a 1b                	push   $0x1b
  jmp alltraps
80105fae:	e9 f4 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fb5:	6a 1c                	push   $0x1c
  jmp alltraps
80105fb7:	e9 eb f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fbe:	6a 1d                	push   $0x1d
  jmp alltraps
80105fc0:	e9 e2 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fc7:	6a 1e                	push   $0x1e
  jmp alltraps
80105fc9:	e9 d9 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fd0:	6a 1f                	push   $0x1f
  jmp alltraps
80105fd2:	e9 d0 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fd9:	6a 20                	push   $0x20
  jmp alltraps
80105fdb:	e9 c7 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105fe2:	6a 21                	push   $0x21
  jmp alltraps
80105fe4:	e9 be f9 ff ff       	jmp    801059a7 <alltraps>
...
80105feb:	6a 22                	push   $0x22
  jmp alltraps
80105fed:	e9 b5 f9 ff ff       	jmp    801059a7 <alltraps>
...
80105ff4:	6a 23                	push   $0x23
  jmp alltraps
80105ff6:	e9 ac f9 ff ff       	jmp    801059a7 <alltraps>
...
80105ffd:	6a 24                	push   $0x24
  jmp alltraps
80105fff:	e9 a3 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106006:	6a 25                	push   $0x25
  jmp alltraps
80106008:	e9 9a f9 ff ff       	jmp    801059a7 <alltraps>
...
8010600f:	6a 26                	push   $0x26
  jmp alltraps
80106011:	e9 91 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106018:	6a 27                	push   $0x27
  jmp alltraps
8010601a:	e9 88 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106021:	6a 28                	push   $0x28
  jmp alltraps
80106023:	e9 7f f9 ff ff       	jmp    801059a7 <alltraps>
...
8010602a:	6a 29                	push   $0x29
  jmp alltraps
8010602c:	e9 76 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106033:	6a 2a                	push   $0x2a
  jmp alltraps
80106035:	e9 6d f9 ff ff       	jmp    801059a7 <alltraps>
...
8010603c:	6a 2b                	push   $0x2b
  jmp alltraps
8010603e:	e9 64 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106045:	6a 2c                	push   $0x2c
  jmp alltraps
80106047:	e9 5b f9 ff ff       	jmp    801059a7 <alltraps>
...
8010604e:	6a 2d                	push   $0x2d
  jmp alltraps
80106050:	e9 52 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106057:	6a 2e                	push   $0x2e
  jmp alltraps
80106059:	e9 49 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106060:	6a 2f                	push   $0x2f
  jmp alltraps
80106062:	e9 40 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106069:	6a 30                	push   $0x30
  jmp alltraps
8010606b:	e9 37 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106072:	6a 31                	push   $0x31
  jmp alltraps
80106074:	e9 2e f9 ff ff       	jmp    801059a7 <alltraps>
...
8010607b:	6a 32                	push   $0x32
  jmp alltraps
8010607d:	e9 25 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106084:	6a 33                	push   $0x33
  jmp alltraps
80106086:	e9 1c f9 ff ff       	jmp    801059a7 <alltraps>
...
8010608d:	6a 34                	push   $0x34
  jmp alltraps
8010608f:	e9 13 f9 ff ff       	jmp    801059a7 <alltraps>
...
80106096:	6a 35                	push   $0x35
  jmp alltraps
80106098:	e9 0a f9 ff ff       	jmp    801059a7 <alltraps>
...
8010609f:	6a 36                	push   $0x36
  jmp alltraps
801060a1:	e9 01 f9 ff ff       	jmp    801059a7 <alltraps>
...
801060a8:	6a 37                	push   $0x37
  jmp alltraps
801060aa:	e9 f8 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060b1:	6a 38                	push   $0x38
  jmp alltraps
801060b3:	e9 ef f8 ff ff       	jmp    801059a7 <alltraps>
...
801060ba:	6a 39                	push   $0x39
  jmp alltraps
801060bc:	e9 e6 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060c3:	6a 3a                	push   $0x3a
  jmp alltraps
801060c5:	e9 dd f8 ff ff       	jmp    801059a7 <alltraps>
...
801060cc:	6a 3b                	push   $0x3b
  jmp alltraps
801060ce:	e9 d4 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060d5:	6a 3c                	push   $0x3c
  jmp alltraps
801060d7:	e9 cb f8 ff ff       	jmp    801059a7 <alltraps>
...
801060de:	6a 3d                	push   $0x3d
  jmp alltraps
801060e0:	e9 c2 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060e7:	6a 3e                	push   $0x3e
  jmp alltraps
801060e9:	e9 b9 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060f0:	6a 3f                	push   $0x3f
  jmp alltraps
801060f2:	e9 b0 f8 ff ff       	jmp    801059a7 <alltraps>
...
801060f9:	6a 40                	push   $0x40
  jmp alltraps
801060fb:	e9 a7 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106102:	6a 41                	push   $0x41
  jmp alltraps
80106104:	e9 9e f8 ff ff       	jmp    801059a7 <alltraps>
...
8010610b:	6a 42                	push   $0x42
  jmp alltraps
8010610d:	e9 95 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106114:	6a 43                	push   $0x43
  jmp alltraps
80106116:	e9 8c f8 ff ff       	jmp    801059a7 <alltraps>
...
8010611d:	6a 44                	push   $0x44
  jmp alltraps
8010611f:	e9 83 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106126:	6a 45                	push   $0x45
  jmp alltraps
80106128:	e9 7a f8 ff ff       	jmp    801059a7 <alltraps>
...
8010612f:	6a 46                	push   $0x46
  jmp alltraps
80106131:	e9 71 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106138:	6a 47                	push   $0x47
  jmp alltraps
8010613a:	e9 68 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106141:	6a 48                	push   $0x48
  jmp alltraps
80106143:	e9 5f f8 ff ff       	jmp    801059a7 <alltraps>
...
8010614a:	6a 49                	push   $0x49
  jmp alltraps
8010614c:	e9 56 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106153:	6a 4a                	push   $0x4a
  jmp alltraps
80106155:	e9 4d f8 ff ff       	jmp    801059a7 <alltraps>
...
8010615c:	6a 4b                	push   $0x4b
  jmp alltraps
8010615e:	e9 44 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106165:	6a 4c                	push   $0x4c
  jmp alltraps
80106167:	e9 3b f8 ff ff       	jmp    801059a7 <alltraps>
...
8010616e:	6a 4d                	push   $0x4d
  jmp alltraps
80106170:	e9 32 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106177:	6a 4e                	push   $0x4e
  jmp alltraps
80106179:	e9 29 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106180:	6a 4f                	push   $0x4f
  jmp alltraps
80106182:	e9 20 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106189:	6a 50                	push   $0x50
  jmp alltraps
8010618b:	e9 17 f8 ff ff       	jmp    801059a7 <alltraps>
...
80106192:	6a 51                	push   $0x51
  jmp alltraps
80106194:	e9 0e f8 ff ff       	jmp    801059a7 <alltraps>
...
8010619b:	6a 52                	push   $0x52
  jmp alltraps
8010619d:	e9 05 f8 ff ff       	jmp    801059a7 <alltraps>
...
801061a4:	6a 53                	push   $0x53
  jmp alltraps
801061a6:	e9 fc f7 ff ff       	jmp    801059a7 <alltraps>
...
801061ad:	6a 54                	push   $0x54
  jmp alltraps
801061af:	e9 f3 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061b6:	6a 55                	push   $0x55
  jmp alltraps
801061b8:	e9 ea f7 ff ff       	jmp    801059a7 <alltraps>
...
801061bf:	6a 56                	push   $0x56
  jmp alltraps
801061c1:	e9 e1 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061c8:	6a 57                	push   $0x57
  jmp alltraps
801061ca:	e9 d8 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061d1:	6a 58                	push   $0x58
  jmp alltraps
801061d3:	e9 cf f7 ff ff       	jmp    801059a7 <alltraps>
...
801061da:	6a 59                	push   $0x59
  jmp alltraps
801061dc:	e9 c6 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061e3:	6a 5a                	push   $0x5a
  jmp alltraps
801061e5:	e9 bd f7 ff ff       	jmp    801059a7 <alltraps>
...
801061ec:	6a 5b                	push   $0x5b
  jmp alltraps
801061ee:	e9 b4 f7 ff ff       	jmp    801059a7 <alltraps>
...
801061f5:	6a 5c                	push   $0x5c
  jmp alltraps
801061f7:	e9 ab f7 ff ff       	jmp    801059a7 <alltraps>
...
801061fe:	6a 5d                	push   $0x5d
  jmp alltraps
80106200:	e9 a2 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106207:	6a 5e                	push   $0x5e
  jmp alltraps
80106209:	e9 99 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106210:	6a 5f                	push   $0x5f
  jmp alltraps
80106212:	e9 90 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106219:	6a 60                	push   $0x60
  jmp alltraps
8010621b:	e9 87 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106222:	6a 61                	push   $0x61
  jmp alltraps
80106224:	e9 7e f7 ff ff       	jmp    801059a7 <alltraps>
...
8010622b:	6a 62                	push   $0x62
  jmp alltraps
8010622d:	e9 75 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106234:	6a 63                	push   $0x63
  jmp alltraps
80106236:	e9 6c f7 ff ff       	jmp    801059a7 <alltraps>
...
8010623d:	6a 64                	push   $0x64
  jmp alltraps
8010623f:	e9 63 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106246:	6a 65                	push   $0x65
  jmp alltraps
80106248:	e9 5a f7 ff ff       	jmp    801059a7 <alltraps>
...
8010624f:	6a 66                	push   $0x66
  jmp alltraps
80106251:	e9 51 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106258:	6a 67                	push   $0x67
  jmp alltraps
8010625a:	e9 48 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106261:	6a 68                	push   $0x68
  jmp alltraps
80106263:	e9 3f f7 ff ff       	jmp    801059a7 <alltraps>
...
8010626a:	6a 69                	push   $0x69
  jmp alltraps
8010626c:	e9 36 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106273:	6a 6a                	push   $0x6a
  jmp alltraps
80106275:	e9 2d f7 ff ff       	jmp    801059a7 <alltraps>
...
8010627c:	6a 6b                	push   $0x6b
  jmp alltraps
8010627e:	e9 24 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106285:	6a 6c                	push   $0x6c
  jmp alltraps
80106287:	e9 1b f7 ff ff       	jmp    801059a7 <alltraps>
...
8010628e:	6a 6d                	push   $0x6d
  jmp alltraps
80106290:	e9 12 f7 ff ff       	jmp    801059a7 <alltraps>
...
80106297:	6a 6e                	push   $0x6e
  jmp alltraps
80106299:	e9 09 f7 ff ff       	jmp    801059a7 <alltraps>
...
801062a0:	6a 6f                	push   $0x6f
  jmp alltraps
801062a2:	e9 00 f7 ff ff       	jmp    801059a7 <alltraps>
...
801062a9:	6a 70                	push   $0x70
  jmp alltraps
801062ab:	e9 f7 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062b2:	6a 71                	push   $0x71
  jmp alltraps
801062b4:	e9 ee f6 ff ff       	jmp    801059a7 <alltraps>
...
801062bb:	6a 72                	push   $0x72
  jmp alltraps
801062bd:	e9 e5 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062c4:	6a 73                	push   $0x73
  jmp alltraps
801062c6:	e9 dc f6 ff ff       	jmp    801059a7 <alltraps>
...
801062cd:	6a 74                	push   $0x74
  jmp alltraps
801062cf:	e9 d3 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062d6:	6a 75                	push   $0x75
  jmp alltraps
801062d8:	e9 ca f6 ff ff       	jmp    801059a7 <alltraps>
...
801062df:	6a 76                	push   $0x76
  jmp alltraps
801062e1:	e9 c1 f6 ff ff       	jmp    801059a7 <alltraps>
...
801062f1:	6a 78                	push   $0x78
  jmp alltraps
801062f3:	e9 af f6 ff ff       	jmp    801059a7 <alltraps>
...
801062fa:	6a 79                	push   $0x79
  jmp alltraps
801062fc:	e9 a6 f6 ff ff       	jmp    801059a7 <alltraps>
...
80106303:	6a 7a                	push   $0x7a
  jmp alltraps
80106305:	e9 9d f6 ff ff       	jmp    801059a7 <alltraps>
...
80106315:	6a 7c                	push   $0x7c
  jmp alltraps
80106317:	e9 8b f6 ff ff       	jmp    801059a7 <alltraps>
...
8010631e:	6a 7d                	push   $0x7d
  jmp alltraps
80106320:	e9 82 f6 ff ff       	jmp    801059a7 <alltraps>
...
80106327:	6a 7e                	push   $0x7e
  jmp alltraps
80106329:	e9 79 f6 ff ff       	jmp    801059a7 <alltraps>
...
80106909:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010690e:	e9 94 f0 ff ff       	jmp    801059a7 <alltraps>
...
80106915:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010691a:	e9 88 f0 ff ff       	jmp    801059a7 <alltraps>
...
80106921:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106926:	e9 7c f0 ff ff       	jmp    801059a7 <alltraps>
...
8010692d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106932:	e9 70 f0 ff ff       	jmp    801059a7 <alltraps>
...
801069df:	68 86 7d 10 80       	push   $0x80107d86
...
801069f3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069f6:	e8 65 cf ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106ac7:	e8 b4 bb ff ff       	call   80102680 <kalloc>
...
80106add:	e8 8e db ff ff       	call   80104670 <memset>
...
80106b8c:	75 b2                	jne    80106b40 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106b8e:	e8 ed ba ff ff       	call   80102680 <kalloc>
...
80106ba5:	e8 c6 da ff ff       	call   80104670 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106bed:	68 38 84 10 80       	push   $0x80108438
...
80106c00:	a1 c4 a5 11 80       	mov    0x8011a5c4,%eax
...
80106c34:	0f 84 c2 00 00 00    	je     80106cfc <switchuvm+0xec>
  pushcli();
80106c3a:	e8 21 d8 ff ff       	call   80104460 <pushcli>
...
80106d4f:	e8 1c d9 ff ff       	call   80104670 <memset>
...
80106d84:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d85:	e9 86 d9 ff ff       	jmp    80104710 <memmove>
    panic("inituvm: more than a page");
80106d8a:	83 ec 0c             	sub    $0xc,%esp
80106d8d:	68 7d 84 10 80       	push   $0x8010847d
...
80106df0:	68 97 84 10 80       	push   $0x80108497
...
80106e78:	68 38 85 10 80       	push   $0x80108538
...
80106edb:	e8 90 d7 ff ff       	call   80104670 <memset>
...
80106f0a:	0f 86 a0 00 00 00    	jbe    80106fb0 <allocuvm+0x120>
    mem = kalloc();
80106f10:	e8 6b b7 ff ff       	call   80102680 <kalloc>
...
80106f1e:	68 b5 84 10 80       	push   $0x801084b5
...
80106f73:	68 cd 84 10 80       	push   $0x801084cd
...
80106f9b:	e8 20 b5 ff ff       	call   801024c0 <kfree>
      return 0;
...
8010705c:	68 e9 84 10 80       	push   $0x801084e9
...
80107090:	e8 db d5 ff ff       	call   80104670 <memset>
...
8010712c:	68 fa 84 10 80       	push   $0x801084fa
...
80107173:	0f 84 c0 00 00 00    	je     80107239 <copyuvm+0xd9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107179:	8b 55 0c             	mov    0xc(%ebp),%edx
8010717c:	85 d2                	test   %edx,%edx
8010717e:	0f 84 b5 00 00 00    	je     80107239 <copyuvm+0xd9>
...
801071a2:	68 04 85 10 80       	push   $0x80108504
...
801071c9:	74 d4                	je     8010719f <copyuvm+0x3f>
    if(!(*pte & PTE_P))
801071cb:	8b 38                	mov    (%eax),%edi
801071cd:	f7 c7 01 00 00 00    	test   $0x1,%edi
801071d3:	0f 84 9b 00 00 00    	je     80107274 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801071d9:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
801071db:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
801071e1:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
801071e4:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if((mem = kalloc()) == 0)
801071ea:	e8 91 b4 ff ff       	call   80102680 <kalloc>
801071ef:	89 c7                	mov    %eax,%edi
801071f1:	85 c0                	test   %eax,%eax
801071f3:	74 5f                	je     80107254 <copyuvm+0xf4>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
801071f5:	83 ec 04             	sub    $0x4,%esp
801071f8:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
801071fe:	68 00 10 00 00       	push   $0x1000
80107203:	53                   	push   %ebx
80107204:	50                   	push   %eax
80107205:	e8 06 d5 ff ff       	call   80104710 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
8010720a:	58                   	pop    %eax
8010720b:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80107211:	ff 75 e4             	push   -0x1c(%ebp)
80107214:	50                   	push   %eax
80107215:	68 00 10 00 00       	push   $0x1000
8010721a:	56                   	push   %esi
8010721b:	ff 75 e0             	push   -0x20(%ebp)
8010721e:	e8 ed f8 ff ff       	call   80106b10 <mappages>
80107223:	83 c4 20             	add    $0x20,%esp
80107226:	85 c0                	test   %eax,%eax
80107228:	78 1e                	js     80107248 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
8010722a:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107230:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107233:	0f 87 57 ff ff ff    	ja     80107190 <copyuvm+0x30>
  return d;
...
80107277:	68 1e 85 10 80       	push   $0x8010851e
...
80107330:	e8 db d3 ff ff       	call   80104710 <memmove>
    len -= n;
    buf += n;
...
801073b6:	0f 0b                	ud2    
801073b8:	66 90                	xchg   %ax,%ax
801073ba:	66 90                	xchg   %ax,%ax
801073bc:	66 90                	xchg   %ax,%ax
801073be:	66 90                	xchg   %ax,%ax

801073c0 <selectionSort>:
#include "memlayout.h"
#include "param.h"
#include "fs.h"
#include "file.h"
...
801073c6:	83 ec 14             	sub    $0x14,%esp
    int i, j, minIndex;
    struct mapping temp;
    for (i = 0; i < n - 1; i++) {
...
801073cc:	8b 7d 08             	mov    0x8(%ebp),%edi
    for (i = 0; i < n - 1; i++) {
801073cf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
801073d6:	83 e8 01             	sub    $0x1,%eax
801073d9:	89 45 e0             	mov    %eax,-0x20(%ebp)
801073dc:	85 c0                	test   %eax,%eax
801073de:	0f 8e a8 00 00 00    	jle    8010748c <selectionSort+0xcc>
801073e4:	89 fa                	mov    %edi,%edx
801073e6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801073ed:	8d 76 00             	lea    0x0(%esi),%esi
        minIndex = i;
        for (j = i + 1; j < n; j++) {
801073f0:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801073f3:	89 ce                	mov    %ecx,%esi
801073f5:	83 c1 01             	add    $0x1,%ecx
801073f8:	89 4d f0             	mov    %ecx,-0x10(%ebp)
801073fb:	39 4d 0c             	cmp    %ecx,0xc(%ebp)
801073fe:	0f 8e 94 00 00 00    	jle    80107498 <selectionSort+0xd8>
80107404:	8d 42 14             	lea    0x14(%edx),%eax
80107407:	89 55 ec             	mov    %edx,-0x14(%ebp)
8010740a:	8b 7d 08             	mov    0x8(%ebp),%edi
8010740d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
...
80107418:	8d 04 b6             	lea    (%esi,%esi,4),%eax
8010741b:	8d 04 87             	lea    (%edi,%eax,4),%eax
8010741e:	8b 10                	mov    (%eax),%edx
80107420:	39 13                	cmp    %edx,(%ebx)
80107422:	73 04                	jae    80107428 <selectionSort+0x68>
80107424:	89 d8                	mov    %ebx,%eax
80107426:	89 ce                	mov    %ecx,%esi
        for (j = i + 1; j < n; j++) {
80107428:	83 c1 01             	add    $0x1,%ecx
8010742b:	83 c3 14             	add    $0x14,%ebx
8010742e:	39 4d 0c             	cmp    %ecx,0xc(%ebp)
80107431:	75 e5                	jne    80107418 <selectionSort+0x58>
80107433:	89 7d 08             	mov    %edi,0x8(%ebp)
80107436:	8b 55 ec             	mov    -0x14(%ebp),%edx
                minIndex = j;
            }
        }
        // Swap arr[i] and arr[minIndex]
        temp = arr[i];
80107439:	8b 7a 0c             	mov    0xc(%edx),%edi
8010743c:	8b 0a                	mov    (%edx),%ecx
8010743e:	8b 5a 04             	mov    0x4(%edx),%ebx
80107441:	8b 72 08             	mov    0x8(%edx),%esi
80107444:	89 7d ec             	mov    %edi,-0x14(%ebp)
80107447:	8b 7a 10             	mov    0x10(%edx),%edi
8010744a:	89 7d e8             	mov    %edi,-0x18(%ebp)
        arr[i] = arr[minIndex];
8010744d:	8b 38                	mov    (%eax),%edi
8010744f:	89 3a                	mov    %edi,(%edx)
80107451:	8b 78 04             	mov    0x4(%eax),%edi
80107454:	89 7a 04             	mov    %edi,0x4(%edx)
80107457:	8b 78 08             	mov    0x8(%eax),%edi
8010745a:	89 7a 08             	mov    %edi,0x8(%edx)
8010745d:	8b 78 0c             	mov    0xc(%eax),%edi
80107460:	89 7a 0c             	mov    %edi,0xc(%edx)
80107463:	8b 78 10             	mov    0x10(%eax),%edi
80107466:	89 7a 10             	mov    %edi,0x10(%edx)
        arr[minIndex] = temp;
80107469:	8b 7d ec             	mov    -0x14(%ebp),%edi
8010746c:	89 70 08             	mov    %esi,0x8(%eax)
    for (i = 0; i < n - 1; i++) {
8010746f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
        arr[minIndex] = temp;
80107472:	89 78 0c             	mov    %edi,0xc(%eax)
80107475:	8b 7d e8             	mov    -0x18(%ebp),%edi
80107478:	89 08                	mov    %ecx,(%eax)
    for (i = 0; i < n - 1; i++) {
8010747a:	8b 75 e0             	mov    -0x20(%ebp),%esi
        arr[minIndex] = temp;
8010747d:	89 58 04             	mov    %ebx,0x4(%eax)
80107480:	89 78 10             	mov    %edi,0x10(%eax)
    for (i = 0; i < n - 1; i++) {
80107483:	39 75 f0             	cmp    %esi,-0x10(%ebp)
80107486:	0f 85 64 ff ff ff    	jne    801073f0 <selectionSort+0x30>
    }
}
8010748c:	83 c4 14             	add    $0x14,%esp
8010748f:	5b                   	pop    %ebx
80107490:	5e                   	pop    %esi
80107491:	5f                   	pop    %edi
80107492:	5d                   	pop    %ebp
...
80107498:	8d 72 14             	lea    0x14(%edx),%esi
        temp = arr[i];
8010749b:	89 d0                	mov    %edx,%eax
8010749d:	89 75 e4             	mov    %esi,-0x1c(%ebp)
801074a0:	eb 97                	jmp    80107439 <selectionSort+0x79>
...
801074b9:	8b 5d 08             	mov    0x8(%ebp),%ebx
    struct proc *curproc = myproc();
801074bc:	e8 bf c4 ff ff       	call   80103980 <myproc>
...
801074c1:	8b b8 bc 01 00 00    	mov    0x1bc(%eax),%edi
    struct proc *curproc = myproc();
801074c7:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if (curproc->num_mappings >= MAX_WMMAP_INFO || length <= 0 || ((curproc->mappings->flags & MAP_PRIVATE) && (curproc->mappings->flags & MAP_SHARED))) {
801074ca:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801074cd:	83 ff 0f             	cmp    $0xf,%edi
801074d0:	0f 8f 72 01 00 00    	jg     80107648 <wmap+0x198>
801074d6:	8b 55 0c             	mov    0xc(%ebp),%edx
801074d9:	85 d2                	test   %edx,%edx
801074db:	0f 8e 67 01 00 00    	jle    80107648 <wmap+0x198>
801074e1:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
801074e7:	89 45 dc             	mov    %eax,-0x24(%ebp)
801074ea:	83 e0 03             	and    $0x3,%eax
801074ed:	83 f8 03             	cmp    $0x3,%eax
801074f0:	0f 84 52 01 00 00    	je     80107648 <wmap+0x198>
        return FAILED;
    }
    uint new_addr = 0x60000000;
    if (flags & MAP_FIXED) { // Consider case of fixed addr
801074f6:	f6 45 10 08          	testb  $0x8,0x10(%ebp)
801074fa:	0f 85 d0 00 00 00    	jne    801075d0 <wmap+0x120>
                return FAILED;
            }
        }
        new_addr = addr;
...
80107500:	85 ff                	test   %edi,%edi
80107502:	0f 8e 58 01 00 00    	jle    80107660 <wmap+0x1b0>
80107508:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010750b:	8d 70 7c             	lea    0x7c(%eax),%esi
8010750e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107511:	89 75 dc             	mov    %esi,-0x24(%ebp)
80107514:	89 f2                	mov    %esi,%edx
80107516:	8d 04 80             	lea    (%eax,%eax,4),%eax
80107519:	8d 3c 86             	lea    (%esi,%eax,4),%edi
    uint new_addr = 0x60000000;
8010751c:	b8 00 00 00 60       	mov    $0x60000000,%eax
80107521:	eb 29                	jmp    8010754c <wmap+0x9c>
...
80107528:	8b 75 0c             	mov    0xc(%ebp),%esi
8010752b:	01 c6                	add    %eax,%esi
8010752d:	39 ce                	cmp    %ecx,%esi
8010752f:	73 04                	jae    80107535 <wmap+0x85>
80107531:	39 f3                	cmp    %esi,%ebx
80107533:	76 26                	jbe    8010755b <wmap+0xab>
80107535:	39 c3                	cmp    %eax,%ebx
80107537:	72 04                	jb     8010753d <wmap+0x8d>
80107539:	39 f3                	cmp    %esi,%ebx
8010753b:	72 1e                	jb     8010755b <wmap+0xab>
8010753d:	39 ce                	cmp    %ecx,%esi
8010753f:	76 04                	jbe    80107545 <wmap+0x95>
80107541:	39 c1                	cmp    %eax,%ecx
80107543:	73 16                	jae    8010755b <wmap+0xab>
        for (int i = 0; i < curproc->num_mappings; i++) {
80107545:	83 c2 14             	add    $0x14,%edx
80107548:	39 d7                	cmp    %edx,%edi
8010754a:	74 23                	je     8010756f <wmap+0xbf>
            uint mapping_end = curproc->mappings[i].addr + (uint) curproc->mappings[i].length;
8010754c:	8b 1a                	mov    (%edx),%ebx
8010754e:	8b 4a 04             	mov    0x4(%edx),%ecx
80107551:	01 d9                	add    %ebx,%ecx
            if ((new_addr >= curproc->mappings[i].addr && new_addr < mapping_end) || (new_addr + (uint) length >= curproc->mappings[i].addr && new_addr + (uint) length < mapping_end) || (curproc->mappings[i].addr >= new_addr && curproc->mappings[i].addr < new_addr + (uint) length) || (mapping_end >= new_addr && mapping_end < new_addr + (uint) length)) {
80107553:	39 c3                	cmp    %eax,%ebx
80107555:	77 d1                	ja     80107528 <wmap+0x78>
80107557:	39 c1                	cmp    %eax,%ecx
80107559:	76 cd                	jbe    80107528 <wmap+0x78>
                new_addr = PGROUNDUP(mapping_end);
8010755b:	81 c1 ff 0f 00 00    	add    $0xfff,%ecx
        for (int i = 0; i < curproc->num_mappings; i++) {
80107561:	83 c2 14             	add    $0x14,%edx
                new_addr = PGROUNDUP(mapping_end);
80107564:	89 c8                	mov    %ecx,%eax
80107566:	25 00 f0 ff ff       	and    $0xfffff000,%eax
        for (int i = 0; i < curproc->num_mappings; i++) {
8010756b:	39 d7                	cmp    %edx,%edi
8010756d:	75 dd                	jne    8010754c <wmap+0x9c>
...
8010756f:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80107572:	8b 7d e0             	mov    -0x20(%ebp),%edi
80107575:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    selectionSort(curproc->mappings, curproc->num_mappings);
80107578:	83 ec 08             	sub    $0x8,%esp
    curproc->mappings[curproc->num_mappings++] = new_mapping;
8010757b:	8b 5d 14             	mov    0x14(%ebp),%ebx
8010757e:	8d 0c b6             	lea    (%esi,%esi,4),%ecx
80107581:	8d 56 01             	lea    0x1(%esi),%edx
80107584:	8d 0c 8f             	lea    (%edi,%ecx,4),%ecx
80107587:	89 97 bc 01 00 00    	mov    %edx,0x1bc(%edi)
8010758d:	89 41 7c             	mov    %eax,0x7c(%ecx)
80107590:	8b 45 0c             	mov    0xc(%ebp),%eax
80107593:	89 99 88 00 00 00    	mov    %ebx,0x88(%ecx)
80107599:	89 81 80 00 00 00    	mov    %eax,0x80(%ecx)
8010759f:	8b 45 10             	mov    0x10(%ebp),%eax
801075a2:	c7 81 8c 00 00 00 00 	movl   $0x0,0x8c(%ecx)
801075a9:	00 00 00 
801075ac:	89 81 84 00 00 00    	mov    %eax,0x84(%ecx)
    selectionSort(curproc->mappings, curproc->num_mappings);
801075b2:	52                   	push   %edx
801075b3:	ff 75 dc             	push   -0x24(%ebp)
801075b6:	e8 05 fe ff ff       	call   801073c0 <selectionSort>
...
801075d0:	8d 93 00 00 00 a0    	lea    -0x60000000(%ebx),%edx
        return FAILED;
801075d6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
        if (addr < 0x60000000 || addr >= 0x80000000 || addr % PGSIZE != 0) {
801075db:	81 fa ff ff ff 1f    	cmp    $0x1fffffff,%edx
801075e1:	77 6a                	ja     8010764d <wmap+0x19d>
801075e3:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
801075e9:	75 62                	jne    8010764d <wmap+0x19d>
        for (int i = 0; i < curproc->num_mappings; i++) {
801075eb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801075ee:	85 c0                	test   %eax,%eax
801075f0:	0f 8e 7d 00 00 00    	jle    80107673 <wmap+0x1c3>
801075f6:	8b 45 e0             	mov    -0x20(%ebp),%eax
                (addr + (uint) length >= curproc->mappings[i].addr && addr + (uint) length < mapping_end)||
801075f9:	8b 7d 0c             	mov    0xc(%ebp),%edi
        for (int i = 0; i < curproc->num_mappings; i++) {
801075fc:	31 f6                	xor    %esi,%esi
801075fe:	83 c0 7c             	add    $0x7c,%eax
                (addr + (uint) length >= curproc->mappings[i].addr && addr + (uint) length < mapping_end)||
80107601:	01 df                	add    %ebx,%edi
80107603:	89 45 dc             	mov    %eax,-0x24(%ebp)
80107606:	89 c2                	mov    %eax,%edx
80107608:	eb 1d                	jmp    80107627 <wmap+0x177>
8010760a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80107610:	39 f8                	cmp    %edi,%eax
80107612:	76 34                	jbe    80107648 <wmap+0x198>
                (mapping_end >= addr && mapping_end < addr + (uint) length)
80107614:	39 cb                	cmp    %ecx,%ebx
80107616:	77 04                	ja     8010761c <wmap+0x16c>
80107618:	39 cf                	cmp    %ecx,%edi
8010761a:	77 2c                	ja     80107648 <wmap+0x198>
        for (int i = 0; i < curproc->num_mappings; i++) {
8010761c:	83 c6 01             	add    $0x1,%esi
8010761f:	83 c2 14             	add    $0x14,%edx
80107622:	39 75 e4             	cmp    %esi,-0x1c(%ebp)
80107625:	74 31                	je     80107658 <wmap+0x1a8>
            uint mapping_end = curproc->mappings[i].addr + (uint) curproc->mappings[i].length;
80107627:	8b 02                	mov    (%edx),%eax
80107629:	8b 4a 04             	mov    0x4(%edx),%ecx
8010762c:	01 c1                	add    %eax,%ecx
                (addr >= curproc->mappings[i].addr && addr < mapping_end) || // Does the start of the region overlap with current region
8010762e:	39 d8                	cmp    %ebx,%eax
80107630:	77 04                	ja     80107636 <wmap+0x186>
80107632:	39 cb                	cmp    %ecx,%ebx
80107634:	72 12                	jb     80107648 <wmap+0x198>
                (addr + (uint) length >= curproc->mappings[i].addr && addr + (uint) length < mapping_end)||
80107636:	39 cf                	cmp    %ecx,%edi
80107638:	72 d6                	jb     80107610 <wmap+0x160>
                (curproc->mappings[i].addr >= addr && curproc->mappings[i].addr < addr + (uint) length) || 
8010763a:	39 f8                	cmp    %edi,%eax
8010763c:	73 d6                	jae    80107614 <wmap+0x164>
8010763e:	39 d8                	cmp    %ebx,%eax
80107640:	72 d2                	jb     80107614 <wmap+0x164>
...
80107658:	89 d8                	mov    %ebx,%eax
8010765a:	e9 10 ff ff ff       	jmp    8010756f <wmap+0xbf>
8010765f:	90                   	nop
80107660:	8b 55 e0             	mov    -0x20(%ebp),%edx
    uint new_addr = 0x60000000;
80107663:	b8 00 00 00 60       	mov    $0x60000000,%eax
80107668:	83 c2 7c             	add    $0x7c,%edx
8010766b:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010766e:	e9 fc fe ff ff       	jmp    8010756f <wmap+0xbf>
80107673:	8b 55 e0             	mov    -0x20(%ebp),%edx
        for (int i = 0; i < curproc->num_mappings; i++) {
80107676:	89 d8                	mov    %ebx,%eax
80107678:	83 c2 7c             	add    $0x7c,%edx
8010767b:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010767e:	e9 ec fe ff ff       	jmp    8010756f <wmap+0xbf>
80107683:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107699:	8b 7d 08             	mov    0x8(%ebp),%edi
    struct proc *curproc = myproc();
8010769c:	e8 df c2 ff ff       	call   80103980 <myproc>
    if (addr % PGSIZE != 0) {
801076a1:	f7 c7 ff 0f 00 00    	test   $0xfff,%edi
801076a7:	0f 85 33 01 00 00    	jne    801077e0 <wunmap+0x150>
        return FAILED;
    }
    int found = 0;
    for (int i = 0; i < curproc->num_mappings; i++) {
801076ad:	8b 88 bc 01 00 00    	mov    0x1bc(%eax),%ecx
801076b3:	89 c6                	mov    %eax,%esi
801076b5:	85 c9                	test   %ecx,%ecx
801076b7:	0f 8e 23 01 00 00    	jle    801077e0 <wunmap+0x150>
801076bd:	8d 40 7c             	lea    0x7c(%eax),%eax
801076c0:	31 db                	xor    %ebx,%ebx
801076c2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801076c5:	eb 17                	jmp    801076de <wunmap+0x4e>
801076c7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801076ce:	66 90                	xchg   %ax,%ax
801076d0:	83 c3 01             	add    $0x1,%ebx
801076d3:	83 c0 14             	add    $0x14,%eax
801076d6:	39 cb                	cmp    %ecx,%ebx
801076d8:	0f 84 02 01 00 00    	je     801077e0 <wunmap+0x150>
        if (curproc->mappings[i].addr == addr) {
801076de:	39 38                	cmp    %edi,(%eax)
801076e0:	75 ee                	jne    801076d0 <wunmap+0x40>
            uint start = curproc->mappings[i].addr;
            uint end = PGROUNDUP(curproc->mappings[i].addr + curproc->mappings[i].length);
801076e2:	8d 04 9b             	lea    (%ebx,%ebx,4),%eax
801076e5:	8d 04 86             	lea    (%esi,%eax,4),%eax
801076e8:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
801076ee:	8d 94 0f ff 0f 00 00 	lea    0xfff(%edi,%ecx,1),%edx
            found = 1;
            uint anon = curproc->mappings[i].flags & MAP_ANONYMOUS;
801076f5:	8b 88 84 00 00 00    	mov    0x84(%eax),%ecx
            uint end = PGROUNDUP(curproc->mappings[i].addr + curproc->mappings[i].length);
801076fb:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80107701:	89 55 e4             	mov    %edx,-0x1c(%ebp)
            uint shared = curproc->mappings[i].flags & MAP_SHARED;
            // Check for file backing
            if (shared && !anon) {
80107704:	f6 c1 02             	test   $0x2,%cl
80107707:	74 09                	je     80107712 <wunmap+0x82>
80107709:	83 e1 04             	and    $0x4,%ecx
8010770c:	0f 84 de 00 00 00    	je     801077f0 <wunmap+0x160>
...
80107712:	3b 7d e4             	cmp    -0x1c(%ebp),%edi
80107715:	73 68                	jae    8010777f <wunmap+0xef>
80107717:	89 5d dc             	mov    %ebx,-0x24(%ebp)
8010771a:	89 fb                	mov    %edi,%ebx
8010771c:	8b 7d e4             	mov    -0x1c(%ebp),%edi
8010771f:	eb 11                	jmp    80107732 <wunmap+0xa2>
80107721:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107728:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010772e:	39 df                	cmp    %ebx,%edi
80107730:	76 4a                	jbe    8010777c <wunmap+0xec>
...
80107738:	ff 76 04             	push   0x4(%esi)
8010773b:	e8 40 f3 ff ff       	call   80106a80 <walkpgdir>
                if (pte && (*pte & PTE_P)) {
80107740:	83 c4 10             	add    $0x10,%esp
80107743:	85 c0                	test   %eax,%eax
80107745:	74 e1                	je     80107728 <wunmap+0x98>
80107747:	8b 08                	mov    (%eax),%ecx
80107749:	f6 c1 01             	test   $0x1,%cl
8010774c:	74 da                	je     80107728 <wunmap+0x98>
                    kfree(P2V(PTE_ADDR(*pte)));
8010774e:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
80107754:	83 ec 0c             	sub    $0xc,%esp
80107757:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            for (uint start_addr = start; start_addr < end; start_addr += PGSIZE) {
8010775a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
                    kfree(P2V(PTE_ADDR(*pte)));
80107760:	81 c1 00 00 00 80    	add    $0x80000000,%ecx
80107766:	51                   	push   %ecx
80107767:	e8 54 ad ff ff       	call   801024c0 <kfree>
                    *pte = 0;
8010776c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010776f:	83 c4 10             	add    $0x10,%esp
80107772:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
            for (uint start_addr = start; start_addr < end; start_addr += PGSIZE) {
80107778:	39 df                	cmp    %ebx,%edi
8010777a:	77 b6                	ja     80107732 <wunmap+0xa2>
8010777c:	8b 5d dc             	mov    -0x24(%ebp),%ebx
                }
            }
            // Shift all subsequent mappings one position towards the start
            for (int j = i; j < curproc->num_mappings; j++) {
8010777f:	8b 8e bc 01 00 00    	mov    0x1bc(%esi),%ecx
80107785:	39 d9                	cmp    %ebx,%ecx
80107787:	7e 3c                	jle    801077c5 <wunmap+0x135>
80107789:	8b 7d e0             	mov    -0x20(%ebp),%edi
8010778c:	8d 04 9b             	lea    (%ebx,%ebx,4),%eax
8010778f:	8d 14 89             	lea    (%ecx,%ecx,4),%edx
80107792:	8d 44 86 7c          	lea    0x7c(%esi,%eax,4),%eax
80107796:	8d 1c 97             	lea    (%edi,%edx,4),%ebx
80107799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                curproc->mappings[j] = curproc->mappings[j + 1];
801077a0:	8b 50 14             	mov    0x14(%eax),%edx
            for (int j = i; j < curproc->num_mappings; j++) {
801077a3:	83 c0 14             	add    $0x14,%eax
                curproc->mappings[j] = curproc->mappings[j + 1];
801077a6:	89 50 ec             	mov    %edx,-0x14(%eax)
801077a9:	8b 50 04             	mov    0x4(%eax),%edx
801077ac:	89 50 f0             	mov    %edx,-0x10(%eax)
801077af:	8b 50 08             	mov    0x8(%eax),%edx
801077b2:	89 50 f4             	mov    %edx,-0xc(%eax)
801077b5:	8b 50 0c             	mov    0xc(%eax),%edx
801077b8:	89 50 f8             	mov    %edx,-0x8(%eax)
801077bb:	8b 50 10             	mov    0x10(%eax),%edx
801077be:	89 50 fc             	mov    %edx,-0x4(%eax)
            for (int j = i; j < curproc->num_mappings; j++) {
801077c1:	39 c3                	cmp    %eax,%ebx
801077c3:	75 db                	jne    801077a0 <wunmap+0x110>
            }
            curproc->num_mappings--;
801077c5:	83 e9 01             	sub    $0x1,%ecx
        }
    }
    if (!found) {
        return FAILED;
    ...
    return SUCCESS;
801077c8:	31 c0                	xor    %eax,%eax
            curproc->num_mappings--;
801077ca:	89 8e bc 01 00 00    	mov    %ecx,0x1bc(%esi)
}
...
801077f0:	8b 88 88 00 00 00    	mov    0x88(%eax),%ecx
                if (filewrite(f, (char *) start, curproc->mappings[i].length) < 0){
801077f6:	83 ec 04             	sub    $0x4,%esp
                struct file *f = curproc->ofile[curproc->mappings[i].fd];
801077f9:	8b 4c 8e 28          	mov    0x28(%esi,%ecx,4),%ecx
                f->off = 0;
801077fd:	c7 41 14 00 00 00 00 	movl   $0x0,0x14(%ecx)
                if (filewrite(f, (char *) start, curproc->mappings[i].length) < 0){
80107804:	ff b0 80 00 00 00    	push   0x80(%eax)
8010780a:	57                   	push   %edi
8010780b:	51                   	push   %ecx
8010780c:	e8 9f 98 ff ff       	call   801010b0 <filewrite>
80107811:	83 c4 10             	add    $0x10,%esp
80107814:	85 c0                	test   %eax,%eax
80107816:	0f 89 f6 fe ff ff    	jns    80107712 <wunmap+0x82>
                    cprintf("filewrite failed\n");
8010781c:	83 ec 0c             	sub    $0xc,%esp
8010781f:	68 5b 85 10 80       	push   $0x8010855b
80107824:	e8 77 8e ff ff       	call   801006a0 <cprintf>
                    return FAILED; 
80107829:	83 c4 10             	add    $0x10,%esp
8010782c:	83 c8 ff             	or     $0xffffffff,%eax
8010782f:	eb b4                	jmp    801077e5 <wunmap+0x155>
...
8010784c:	8b 5d 10             	mov    0x10(%ebp),%ebx
    if (oldaddr % PGSIZE != 0 || newsize <= 0){
8010784f:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
80107855:	75 79                	jne    801078d0 <wremap+0x90>
80107857:	85 db                	test   %ebx,%ebx
80107859:	7e 75                	jle    801078d0 <wremap+0x90>
        return FAILED;
    }
    struct proc *curproc = myproc();
8010785b:	e8 20 c1 ff ff       	call   80103980 <myproc>
    int found = 0;
    int i;  //get mapping that we want to remap
    for(i = 0; i < curproc->num_mappings; i++){
80107860:	8b 88 bc 01 00 00    	mov    0x1bc(%eax),%ecx
    struct proc *curproc = myproc();
80107866:	89 c7                	mov    %eax,%edi
    for(i = 0; i < curproc->num_mappings; i++){
80107868:	85 c9                	test   %ecx,%ecx
8010786a:	7e 64                	jle    801078d0 <wremap+0x90>
8010786c:	8d 50 7c             	lea    0x7c(%eax),%edx
8010786f:	31 c0                	xor    %eax,%eax
80107871:	eb 0f                	jmp    80107882 <wremap+0x42>
80107873:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107877:	90                   	nop
80107878:	83 c0 01             	add    $0x1,%eax
8010787b:	83 c2 14             	add    $0x14,%edx
8010787e:	39 c8                	cmp    %ecx,%eax
80107880:	74 4e                	je     801078d0 <wremap+0x90>
        if(curproc->mappings[i].addr == oldaddr){
80107882:	39 32                	cmp    %esi,(%edx)
80107884:	75 f2                	jne    80107878 <wremap+0x38>
        return FAILED;
    }
...
80107886:	3b 5d 0c             	cmp    0xc(%ebp),%ebx
80107889:	7e 4a                	jle    801078d5 <wremap+0x95>
        uint end = oldaddr + newsize;
        if (end >= KERNBASE) {
8010788b:	89 da                	mov    %ebx,%edx
8010788d:	01 f2                	add    %esi,%edx
8010788f:	78 3f                	js     801078d0 <wremap+0x90>
            return FAILED;
        }
        if (flags == 0) {
            if (i < curproc->num_mappings - 1) {
80107891:	83 e9 01             	sub    $0x1,%ecx
        if (flags == 0) {
80107894:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80107898:	75 1e                	jne    801078b8 <wremap+0x78>
            if (i < curproc->num_mappings - 1) {
8010789a:	39 c8                	cmp    %ecx,%eax
8010789c:	7d 0a                	jge    801078a8 <wremap+0x68>
                uint next_map_end = curproc->mappings[i + 1].addr;
8010789e:	8d 4c 80 05          	lea    0x5(%eax,%eax,4),%ecx
                if (end >= next_map_end) {
801078a2:	3b 54 8f 7c          	cmp    0x7c(%edi,%ecx,4),%edx
801078a6:	73 28                	jae    801078d0 <wremap+0x90>
                    return FAILED;
                }
            }
            curproc->mappings[i].length = newsize;
801078a8:	8d 04 80             	lea    (%eax,%eax,4),%eax
801078ab:	89 9c 87 80 00 00 00 	mov    %ebx,0x80(%edi,%eax,4)
            return oldaddr;
801078b2:	eb 21                	jmp    801078d5 <wremap+0x95>
801078b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        } else {
            // curproc -> mappings[i].length = newsize;
            if (i < curproc->num_mappings - 1) {
801078b8:	39 c8                	cmp    %ecx,%eax
801078ba:	7d 19                	jge    801078d5 <wremap+0x95>
                uint next_map_end = curproc->mappings[i + 1].addr;
801078bc:	8d 44 80 05          	lea    0x5(%eax,%eax,4),%eax
                if (end >= next_map_end) {
801078c0:	3b 54 87 7c          	cmp    0x7c(%edi,%eax,4),%edx
801078c4:	72 0f                	jb     801078d5 <wremap+0x95>
801078c6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801078cd:	8d 76 00             	lea    0x0(%esi),%esi
        return FAILED;
801078d0:	be ff ff ff ff       	mov    $0xffffffff,%esi
...
801078d5:	83 c4 0c             	add    $0xc,%esp
801078d8:	89 f0                	mov    %esi,%eax
801078da:	5b                   	pop    %ebx
801078db:	5e                   	pop    %esi
801078dc:	5f                   	pop    %edi
801078dd:	5d                   	pop    %ebp
...
801078e9:	8b 5d 08             	mov    0x8(%ebp),%ebx
    struct proc *curproc = myproc();
801078ec:	e8 8f c0 ff ff       	call   80103980 <myproc>
    if (curproc == 0) {
801078f1:	85 c0                	test   %eax,%eax
801078f3:	74 5e                	je     80107953 <getpgdirinfo+0x73>
        return FAILED;
    }
    pde_t *curr_pgdir = curproc->pgdir;
801078f5:	8b 40 04             	mov    0x4(%eax),%eax
    pte_t *pte;
    uint va = 0;
    int user_allocated_pages = 0;
    pdinfo->n_upages = 0;
801078f8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    int user_allocated_pages = 0;
801078fe:	31 f6                	xor    %esi,%esi
    uint va = 0;
80107900:	31 ff                	xor    %edi,%edi
    pde_t *curr_pgdir = curproc->pgdir;
...
8010790d:	57                   	push   %edi
8010790e:	ff 75 e4             	push   -0x1c(%ebp)
80107911:	e8 6a f1 ff ff       	call   80106a80 <walkpgdir>
        if (pte && (*pte & PTE_U)) {
80107916:	83 c4 10             	add    $0x10,%esp
80107919:	85 c0                	test   %eax,%eax
8010791b:	74 1d                	je     8010793a <getpgdirinfo+0x5a>
8010791d:	f6 00 04             	testb  $0x4,(%eax)
80107920:	74 18                	je     8010793a <getpgdirinfo+0x5a>
            // cprintf("0x%x, %x\n", va, (*pte));
            // cprintf("enters if statement\n");
            pdinfo->n_upages++;
80107922:	83 03 01             	addl   $0x1,(%ebx)
            // cprintf("user pages %d\n", pdinfo->n_upages);
            pdinfo->va[user_allocated_pages] = va;
80107925:	89 7c b3 04          	mov    %edi,0x4(%ebx,%esi,4)
            pdinfo->pa[user_allocated_pages] = PTE_ADDR(*pte);
80107929:	8b 00                	mov    (%eax),%eax
8010792b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107930:	89 84 b3 84 00 00 00 	mov    %eax,0x84(%ebx,%esi,4)
            user_allocated_pages++;
80107937:	83 c6 01             	add    $0x1,%esi
        }
        va += PGSIZE;
8010793a:	81 c7 00 10 00 00    	add    $0x1000,%edi
    while (user_allocated_pages < MAX_UPAGE_INFO && va < KERNBASE) {
80107940:	83 fe 1f             	cmp    $0x1f,%esi
80107943:	7f 04                	jg     80107949 <getpgdirinfo+0x69>
80107945:	85 ff                	test   %edi,%edi
80107947:	79 bf                	jns    80107908 <getpgdirinfo+0x28>
    }
    // cprintf("2\n");
    return SUCCESS;
80107949:	31 c0                	xor    %eax,%eax
}
...
80107952:	c3                   	ret    
        return FAILED;
80107953:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107958:	eb f1                	jmp    8010794b <getpgdirinfo+0x6b>
8010795a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107960 <getwmapinfo>:
...
80107965:	8b 5d 08             	mov    0x8(%ebp),%ebx
    struct proc *curproc = myproc();
80107968:	e8 13 c0 ff ff       	call   80103980 <myproc>
    wminfo->total_mmaps = curproc->num_mappings;
8010796d:	8b 88 bc 01 00 00    	mov    0x1bc(%eax),%ecx
80107973:	89 0b                	mov    %ecx,(%ebx)
    for (int i = 0; i < curproc->num_mappings; i++) {
80107975:	85 c9                	test   %ecx,%ecx
80107977:	7e 2c                	jle    801079a5 <getwmapinfo+0x45>
80107979:	89 c6                	mov    %eax,%esi
8010797b:	8d 50 7c             	lea    0x7c(%eax),%edx
8010797e:	31 c0                	xor    %eax,%eax
        wminfo->addr[i] = curproc->mappings[i].addr;
80107980:	8b 0a                	mov    (%edx),%ecx
    for (int i = 0; i < curproc->num_mappings; i++) {
80107982:	83 c2 14             	add    $0x14,%edx
        wminfo->addr[i] = curproc->mappings[i].addr;
80107985:	89 4c 83 04          	mov    %ecx,0x4(%ebx,%eax,4)
        wminfo->length[i] = curproc->mappings[i].length;
80107989:	8b 4a f0             	mov    -0x10(%edx),%ecx
8010798c:	89 4c 83 44          	mov    %ecx,0x44(%ebx,%eax,4)
        wminfo->n_loaded_pages[i] = curproc->mappings[i].num_pages_loaded;
80107990:	8b 4a fc             	mov    -0x4(%edx),%ecx
80107993:	89 8c 83 84 00 00 00 	mov    %ecx,0x84(%ebx,%eax,4)
    for (int i = 0; i < curproc->num_mappings; i++) {
8010799a:	83 c0 01             	add    $0x1,%eax
8010799d:	39 86 bc 01 00 00    	cmp    %eax,0x1bc(%esi)
801079a3:	7f db                	jg     80107980 <getwmapinfo+0x20>
    }
    return SUCCESS;
}
801079a5:	5b                   	pop    %ebx
801079a6:	31 c0                	xor    %eax,%eax
801079a8:	5e                   	pop    %esi
801079a9:	5d                   	pop    %ebp
801079aa:	c3                   	ret    
...
801079b6:	56                   	push   %esi
801079b7:	53                   	push   %ebx
801079b8:	83 ec 1c             	sub    $0x1c,%esp
801079bb:	8b 5d 08             	mov    0x8(%ebp),%ebx
    struct proc *curproc = myproc();
801079be:	e8 bd bf ff ff       	call   80103980 <myproc>
    for (int i = 0; i < curproc->num_mappings; i++) {
801079c3:	8b 88 bc 01 00 00    	mov    0x1bc(%eax),%ecx
801079c9:	89 c6                	mov    %eax,%esi
801079cb:	83 c0 7c             	add    $0x7c,%eax
801079ce:	85 c9                	test   %ecx,%ecx
801079d0:	7e 1d                	jle    801079ef <handle_pagefault+0x3f>
...
801079d8:	8b 10                	mov    (%eax),%edx
801079da:	39 da                	cmp    %ebx,%edx
801079dc:	77 07                	ja     801079e5 <handle_pagefault+0x35>
801079de:	03 50 04             	add    0x4(%eax),%edx
801079e1:	39 da                	cmp    %ebx,%edx
801079e3:	77 1b                	ja     80107a00 <handle_pagefault+0x50>
    for (int i = 0; i < curproc->num_mappings; i++) {
801079e5:	83 c7 01             	add    $0x1,%edi
801079e8:	83 c0 14             	add    $0x14,%eax
801079eb:	39 cf                	cmp    %ecx,%edi
801079ed:	75 e9                	jne    801079d8 <handle_pagefault+0x28>
...
801079ff:	90                   	nop
            char *mem = kalloc();
80107a00:	e8 7b ac ff ff       	call   80102680 <kalloc>
80107a05:	89 c2                	mov    %eax,%edx
            if (mem == 0) {
80107a07:	85 c0                	test   %eax,%eax
80107a09:	74 e4                	je     801079ef <handle_pagefault+0x3f>
            curproc->mappings[i].num_pages_loaded++;
80107a0b:	8d 04 bf             	lea    (%edi,%edi,4),%eax
                success = mappages(curproc->pgdir, (void *)addr, PGSIZE, V2P(mem), PTE_W | PTE_U);
80107a0e:	8d 8a 00 00 00 80    	lea    -0x80000000(%edx),%ecx
            curproc->mappings[i].num_pages_loaded++;
80107a14:	8d 04 86             	lea    (%esi,%eax,4),%eax
            if (curproc->mappings[i].flags & MAP_ANONYMOUS) {
80107a17:	8b b8 84 00 00 00    	mov    0x84(%eax),%edi
            curproc->mappings[i].num_pages_loaded++;
80107a1d:	83 80 8c 00 00 00 01 	addl   $0x1,0x8c(%eax)
            if (curproc->mappings[i].flags & MAP_ANONYMOUS) {
80107a24:	83 e7 04             	and    $0x4,%edi
80107a27:	74 37                	je     80107a60 <handle_pagefault+0xb0>
                success = mappages(curproc->pgdir, (void *)addr, PGSIZE, V2P(mem), PTE_W | PTE_U);
80107a29:	83 ec 0c             	sub    $0xc,%esp
80107a2c:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80107a2f:	6a 06                	push   $0x6
80107a31:	51                   	push   %ecx
80107a32:	68 00 10 00 00       	push   $0x1000
80107a37:	53                   	push   %ebx
80107a38:	ff 76 04             	push   0x4(%esi)
80107a3b:	e8 d0 f0 ff ff       	call   80106b10 <mappages>
                if (success != 0) {
80107a40:	83 c4 20             	add    $0x20,%esp
80107a43:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107a46:	85 c0                	test   %eax,%eax
80107a48:	0f 84 8e 00 00 00    	je     80107adc <handle_pagefault+0x12c>
                    kfree(mem);
80107a4e:	83 ec 0c             	sub    $0xc,%esp
80107a51:	52                   	push   %edx
80107a52:	e8 69 aa ff ff       	call   801024c0 <kfree>
                    return 0;
80107a57:	83 c4 10             	add    $0x10,%esp
80107a5a:	eb 93                	jmp    801079ef <handle_pagefault+0x3f>
80107a5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107a60:	89 4d d8             	mov    %ecx,-0x28(%ebp)
                struct file *f = curproc->ofile[curproc->mappings[i].fd];
80107a63:	8b 88 88 00 00 00    	mov    0x88(%eax),%ecx
                ilock(f->ip);
80107a69:	83 ec 0c             	sub    $0xc,%esp
                struct file *f = curproc->ofile[curproc->mappings[i].fd];
80107a6c:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107a6f:	8b 44 8e 28          	mov    0x28(%esi,%ecx,4),%eax
80107a73:	89 55 dc             	mov    %edx,-0x24(%ebp)
                ilock(f->ip);
80107a76:	ff 70 10             	push   0x10(%eax)
80107a79:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107a7c:	e8 ff 9c ff ff       	call   80101780 <ilock>
                readi(f->ip, mem, addr - curproc->mappings[i].addr, PGSIZE);
80107a81:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107a84:	68 00 10 00 00       	push   $0x1000
80107a89:	89 d9                	mov    %ebx,%ecx
80107a8b:	8b 55 dc             	mov    -0x24(%ebp),%edx
80107a8e:	2b 48 7c             	sub    0x7c(%eax),%ecx
80107a91:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107a94:	51                   	push   %ecx
80107a95:	52                   	push   %edx
80107a96:	ff 70 10             	push   0x10(%eax)
80107a99:	89 55 e0             	mov    %edx,-0x20(%ebp)
80107a9c:	e8 ef 9f ff ff       	call   80101a90 <readi>
                iunlock(f->ip);
80107aa1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107aa4:	83 c4 14             	add    $0x14,%esp
80107aa7:	ff 70 10             	push   0x10(%eax)
80107aaa:	e8 b1 9d ff ff       	call   80101860 <iunlock>
                success = mappages(curproc->pgdir, (void *)addr, PGSIZE, V2P(mem), PTE_W | PTE_U);
80107aaf:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80107ab2:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80107ab9:	51                   	push   %ecx
80107aba:	68 00 10 00 00       	push   $0x1000
80107abf:	53                   	push   %ebx
80107ac0:	ff 76 04             	push   0x4(%esi)
80107ac3:	e8 48 f0 ff ff       	call   80106b10 <mappages>
                if (success != 0) {
80107ac8:	83 c4 20             	add    $0x20,%esp
80107acb:	8b 55 e0             	mov    -0x20(%ebp),%edx
80107ace:	85 c0                	test   %eax,%eax
80107ad0:	75 27                	jne    80107af9 <handle_pagefault+0x149>
                    return 1;
80107ad2:	bf 01 00 00 00       	mov    $0x1,%edi
80107ad7:	e9 15 ff ff ff       	jmp    801079f1 <handle_pagefault+0x41>
                    memset(mem, 0, PGSIZE);
80107adc:	83 ec 04             	sub    $0x4,%esp
                    return 1;
80107adf:	bf 01 00 00 00       	mov    $0x1,%edi
                    memset(mem, 0, PGSIZE);
80107ae4:	68 00 10 00 00       	push   $0x1000
80107ae9:	6a 00                	push   $0x0
80107aeb:	52                   	push   %edx
80107aec:	e8 7f cb ff ff       	call   80104670 <memset>
                    return 1;
80107af1:	83 c4 10             	add    $0x10,%esp
80107af4:	e9 f8 fe ff ff       	jmp    801079f1 <handle_pagefault+0x41>
                    kfree(mem);
80107af9:	83 ec 0c             	sub    $0xc,%esp
80107afc:	52                   	push   %edx
80107afd:	e8 be a9 ff ff       	call   801024c0 <kfree>
                    return 0;
80107b02:	83 c4 10             	add    $0x10,%esp
80107b05:	e9 e7 fe ff ff       	jmp    801079f1 <handle_pagefault+0x41>
