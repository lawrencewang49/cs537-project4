...
80100028:	bc 00 76 14 80       	mov    $0x80147600,%esp
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 87 81 10 80 	movl   $0x80108187,(%esp)
...
80102088:	68 12 7f 10 80       	push   $0x80107f12
...
801024d2:	81 fb 00 76 14 80    	cmp    $0x80147600,%ebx
...
8010272b:	0f b6 91 60 7b 10 80 	movzbl -0x7fef84a0(%ecx),%edx
  shift ^= togglecode[data];
80102732:	0f b6 81 60 7a 10 80 	movzbl -0x7fef85a0(%ecx),%eax
  shift |= shiftcode[data];
...
80102748:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010274b:	8b 04 85 40 7a 10 80 	mov    -0x7fef85c0(,%eax,4),%eax
...
80102785:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102788:	0f b6 81 60 7b 10 80 	movzbl -0x7fef84a0(%ecx),%eax
...
80102cca:	68 60 7c 10 80       	push   $0x80107c60
...
80102fe1:	68 73 7c 10 80       	push   $0x80107c73
80102fe6:	e8 95 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102feb:	83 ec 0c             	sub    $0xc,%esp
80102fee:	68 89 7c 10 80       	push   $0x80107c89
...
80103018:	68 a4 7c 10 80       	push   $0x80107ca4
...
80103077:	68 00 76 14 80       	push   $0x80147600
...
801031be:	68 b8 7c 10 80       	push   $0x80107cb8
...
80103276:	68 bd 7c 10 80       	push   $0x80107cbd
...
80103393:	68 c2 7c 10 80       	push   $0x80107cc2
...
801033c2:	68 b8 7c 10 80       	push   $0x80107cb8
...
801033f8:	68 dc 7c 10 80       	push   $0x80107cdc
...
801034a0:	00 00 00 
  initlock(&p->lock, "pipe");
801034a3:	68 fb 7c 10 80       	push   $0x80107cfb
...
801037cf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d0:	81 c3 bc 0c 00 00    	add    $0xcbc,%ebx
801037d6:	81 fb 54 5c 14 80    	cmp    $0x80145c54,%ebx
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 bf 59 10 80 	movl   $0x801059bf,0x14(%eax)
  p->context = (struct context*)sp;
...
801038e6:	68 00 7d 10 80       	push   $0x80107d00
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 54 5c 14 80       	mov    %eax,0x80145c54
...
80103a4f:	68 30 7d 10 80       	push   $0x80107d30
80103a54:	50                   	push   %eax
80103a55:	e8 d6 0d 00 00       	call   80104830 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 39 7d 10 80 	movl   $0x80107d39,(%esp)
...
80103a93:	68 17 7d 10 80       	push   $0x80107d17
...
80103cb6:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb9:	81 c3 bc 0c 00 00    	add    $0xcbc,%ebx
80103cbf:	81 fb 54 5c 14 80    	cmp    $0x80145c54,%ebx
...
80103da9:	e8 d2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dae:	39 05 54 5c 14 80    	cmp    %eax,0x80145c54
...
80103e20:	05 bc 0c 00 00       	add    $0xcbc,%eax
80103e25:	3d 54 5c 14 80       	cmp    $0x80145c54,%eax
...
80103e37:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e3e:	05 bc 0c 00 00       	add    $0xcbc,%eax
80103e43:	3d 54 5c 14 80       	cmp    $0x80145c54,%eax
80103e48:	75 e2                	jne    80103e2c <exit+0x8c>
      p->parent = initproc;
80103e4a:	8b 0d 54 5c 14 80    	mov    0x80145c54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e60:	81 c2 bc 0c 00 00    	add    $0xcbc,%edx
80103e66:	81 fa 54 5c 14 80    	cmp    $0x80145c54,%edx
...
80103e87:	90                   	nop
80103e88:	05 bc 0c 00 00       	add    $0xcbc,%eax
80103e8d:	3d 54 5c 14 80       	cmp    $0x80145c54,%eax
...
80103eb7:	68 88 7d 10 80       	push   $0x80107d88
80103ebc:	e8 bf c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ec1:	83 ec 0c             	sub    $0xc,%esp
80103ec4:	68 7b 7d 10 80       	push   $0x80107d7b
...
80103f07:	90                   	nop
80103f08:	81 c3 bc 0c 00 00    	add    $0xcbc,%ebx
80103f0e:	81 fb 54 5c 14 80    	cmp    $0x80145c54,%ebx
...
80103f1f:	74 5f                	je     80103f80 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f21:	81 c3 bc 0c 00 00    	add    $0xcbc,%ebx
      havekids = 1;
80103f27:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f2c:	81 fb 54 5c 14 80    	cmp    $0x80145c54,%ebx
...
80103ff0:	68 94 7d 10 80       	push   $0x80107d94
...
801040f9:	68 9a 7d 10 80       	push   $0x80107d9a
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 94 7d 10 80       	push   $0x80107d94
...
80104130:	05 bc 0c 00 00       	add    $0xcbc,%eax
80104135:	3d 54 5c 14 80       	cmp    $0x80145c54,%eax
...
80104147:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010414e:	05 bc 0c 00 00       	add    $0xcbc,%eax
80104153:	3d 54 5c 14 80       	cmp    $0x80145c54,%eax
...
80104190:	05 bc 0c 00 00       	add    $0xcbc,%eax
80104195:	3d 54 5c 14 80       	cmp    $0x80145c54,%eax
...
8010420b:	68 87 81 10 80       	push   $0x80108187
80104210:	e8 8b c4 ff ff       	call   801006a0 <cprintf>
80104215:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104218:	81 c3 bc 0c 00 00    	add    $0xcbc,%ebx
8010421e:	81 fb c0 5c 14 80    	cmp    $0x80145cc0,%ebx
...
8010422f:	74 e7                	je     80104218 <procdump+0x28>
      state = "???";
80104231:	ba ab 7d 10 80       	mov    $0x80107dab,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104236:	83 f8 05             	cmp    $0x5,%eax
80104239:	77 11                	ja     8010424c <procdump+0x5c>
8010423b:	8b 14 85 0c 7e 10 80 	mov    -0x7fef81f4(,%eax,4),%edx
      state = "???";
80104242:	b8 ab 7d 10 80       	mov    $0x80107dab,%eax
...
80104251:	68 af 7d 10 80       	push   $0x80107daf
...
8010428d:	68 01 78 10 80       	push   $0x80107801
...
801042ba:	68 24 7e 10 80       	push   $0x80107e24
...
801044f5:	68 2f 7e 10 80       	push   $0x80107e2f
801044fa:	e8 81 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ff:	83 ec 0c             	sub    $0xc,%esp
80104502:	68 46 7e 10 80       	push   $0x80107e46
...
8010456b:	68 4d 7e 10 80       	push   $0x80107e4d
...
80104660:	68 55 7e 10 80       	push   $0x80107e55
...
80104a8c:	8b 14 85 80 7e 10 80 	mov    -0x7fef8180(,%eax,4),%edx
...
80104ab8:	68 5d 7e 10 80       	push   $0x80107e5d
...
80104c14:	68 08 7f 10 80       	push   $0x80107f08
...
80104c2c:	68 07 7f 10 80       	push   $0x80107f07
...
80104c41:	68 fb 7e 10 80       	push   $0x80107efb
...
80104c5f:	68 0a 7f 10 80       	push   $0x80107f0a
80104c64:	e8 17 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c69:	83 ec 0c             	sub    $0xc,%esp
80104c6c:	68 ec 7e 10 80       	push   $0x80107eec
...
8010506d:	58                   	pop    %eax
8010506e:	5a                   	pop    %edx
8010506f:	68 08 7f 10 80       	push   $0x80107f08
...
80105088:	68 07 7f 10 80       	push   $0x80107f07
...
80105790:	68 80 5c 14 80       	push   $0x80145c80
80105795:	e8 16 ee ff ff       	call   801045b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010579a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010579d:	8b 1d 60 5c 14 80    	mov    0x80145c60,%ebx
  while(ticks - ticks0 < n){
...
801057b3:	68 80 5c 14 80       	push   $0x80145c80
801057b8:	68 60 5c 14 80       	push   $0x80145c60
801057bd:	e8 8e e8 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
801057c2:	a1 60 5c 14 80       	mov    0x80145c60,%eax
...
801057e0:	68 80 5c 14 80       	push   $0x80145c80
...
80105803:	68 80 5c 14 80       	push   $0x80145c80
...
80105824:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105827:	68 80 5c 14 80       	push   $0x80145c80
8010582c:	e8 7f ed ff ff       	call   801045b0 <acquire>
  xticks = ticks;
80105831:	8b 1d 60 5c 14 80    	mov    0x80145c60,%ebx
  release(&tickslock);
80105837:	c7 04 24 80 5c 14 80 	movl   $0x80145c80,(%esp)
...
801058c7:	e8 f4 1a 00 00       	call   801073c0 <wmap>
...
801058fe:	e8 2d 1c 00 00       	call   80107530 <wunmap>
...
80105950:	e8 8b 1c 00 00       	call   801075e0 <getpgdirinfo>
...
80105990:	e8 0b 1d 00 00       	call   801076a0 <getwmapinfo>
...
801059e7:	c7 04 c5 c2 5c 14 80 	movl   $0x8e000008,-0x7feba33e(,%eax,8)
801059ee:	08 00 00 8e 
801059f2:	66 89 14 c5 c0 5c 14 	mov    %dx,-0x7feba340(,%eax,8)
801059f9:	80 
801059fa:	c1 ea 10             	shr    $0x10,%edx
801059fd:	66 89 14 c5 c6 5c 14 	mov    %dx,-0x7feba33a(,%eax,8)
80105a04:	80 
  for(i = 0; i < 256; i++)
...
80105a17:	c7 05 c2 5e 14 80 08 	movl   $0xef000008,0x80145ec2
80105a1e:	00 00 ef 
  initlock(&tickslock, "time");
80105a21:	68 4d 7f 10 80       	push   $0x80107f4d
80105a26:	68 80 5c 14 80       	push   $0x80145c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a2b:	66 a3 c0 5e 14 80    	mov    %ax,0x80145ec0
80105a31:	c1 e8 10             	shr    $0x10,%eax
80105a34:	66 a3 c6 5e 14 80    	mov    %ax,0x80145ec6
  initlock(&tickslock, "time");
...
80105a5b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a5f:	b8 c0 5c 14 80       	mov    $0x80145cc0,%eax
...
80105aa4:	ff 24 85 08 80 10 80 	jmp    *-0x7fef7ff8(,%eax,4)
...
80105b85:	68 c4 7f 10 80       	push   $0x80107fc4
...
80105ce3:	68 80 5c 14 80       	push   $0x80145c80
80105ce8:	e8 c3 e8 ff ff       	call   801045b0 <acquire>
      wakeup(&ticks);
80105ced:	c7 04 24 60 5c 14 80 	movl   $0x80145c60,(%esp)
      ticks++;
80105cf4:	83 05 60 5c 14 80 01 	addl   $0x1,0x80145c60
      wakeup(&ticks);
80105cfb:	e8 10 e4 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105d00:	c7 04 24 80 5c 14 80 	movl   $0x80145c80,(%esp)
...
80105d25:	68 90 7f 10 80       	push   $0x80107f90
80105d2a:	e8 71 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105d2f:	83 c4 14             	add    $0x14,%esp
80105d32:	68 66 7f 10 80       	push   $0x80107f66
...
{
  if(!uart)
80105d40:	a1 c0 64 14 80       	mov    0x801464c0,%eax
...
80105dc7:	74 78                	je     80105e41 <uartinit+0xd1>
  uart = 1;
80105dc9:	c7 05 c0 64 14 80 01 	movl   $0x1,0x801464c0
80105dd0:	00 00 00 
...
80105ddc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ddf:	bf d0 80 10 80       	mov    $0x801080d0,%edi
...
80105df9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e00:	a1 c0 64 14 80       	mov    0x801464c0,%eax
...
80105e50 <uartputc>:
  if(!uart)
80105e50:	a1 c0 64 14 80       	mov    0x801464c0,%eax
...
801069df:	68 26 7a 10 80       	push   $0x80107a26
...
80106bed:	68 d8 80 10 80       	push   $0x801080d8
...
80106c00:	a1 c4 64 14 80       	mov    0x801464c4,%eax
...
80106d8d:	68 1d 81 10 80       	push   $0x8010811d
...
80106df0:	68 37 81 10 80       	push   $0x80108137
...
80106e78:	68 d8 81 10 80       	push   $0x801081d8
...
80106f1e:	68 55 81 10 80       	push   $0x80108155
...
80106f73:	68 6d 81 10 80       	push   $0x8010816d
...
8010705c:	68 89 81 10 80       	push   $0x80108189
...
801070fb:	a3 c4 64 14 80       	mov    %eax,0x801464c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010712c:	68 9a 81 10 80       	push   $0x8010819a
...
801071a2:	68 a4 81 10 80       	push   $0x801081a4
...
80107277:	68 be 81 10 80       	push   $0x801081be
...
801073cc:	8b 55 08             	mov    0x8(%ebp),%edx
    if (num_mappings >= MAX_WMMAP_INFO || length <= 0) {
801073cf:	8b 35 e0 64 14 80    	mov    0x801464e0,%esi
801073d5:	85 c0                	test   %eax,%eax
801073d7:	0f 8e 33 01 00 00    	jle    80107510 <wmap+0x150>
801073dd:	83 fe 0f             	cmp    $0xf,%esi
801073e0:	0f 8f 2a 01 00 00    	jg     80107510 <wmap+0x150>
        return FAILED;
    }
    uint new_addr = 0x60000000;
    if (flags & MAP_FIXED) {
801073e6:	f6 45 10 08          	testb  $0x8,0x10(%ebp)
801073ea:	0f 85 a0 00 00 00    	jne    80107490 <wmap+0xd0>
    uint new_addr = 0x60000000;
801073f0:	b8 00 00 00 60       	mov    $0x60000000,%eax
                return FAILED;
            }
        }
        new_addr = addr;
...
801073f5:	85 f6                	test   %esi,%esi
801073f7:	7e 60                	jle    80107459 <wmap+0x99>
801073f9:	89 f0                	mov    %esi,%eax
801073fb:	b9 00 65 14 80       	mov    $0x80146500,%ecx
    uint new_addr = 0x60000000;
80107400:	89 75 f0             	mov    %esi,-0x10(%ebp)
80107403:	c1 e0 04             	shl    $0x4,%eax
80107406:	8d 3c 08             	lea    (%eax,%ecx,1),%edi
80107409:	b8 00 00 00 60       	mov    $0x60000000,%eax
8010740e:	eb 24                	jmp    80107434 <wmap+0x74>
...
80107410:	8b 75 0c             	mov    0xc(%ebp),%esi
80107413:	01 c6                	add    %eax,%esi
80107415:	39 f3                	cmp    %esi,%ebx
80107417:	77 0c                	ja     80107425 <wmap+0x65>
80107419:	39 d6                	cmp    %edx,%esi
8010741b:	72 26                	jb     80107443 <wmap+0x83>
8010741d:	39 f3                	cmp    %esi,%ebx
8010741f:	73 04                	jae    80107425 <wmap+0x65>
80107421:	39 c3                	cmp    %eax,%ebx
80107423:	73 1e                	jae    80107443 <wmap+0x83>
80107425:	39 c2                	cmp    %eax,%edx
80107427:	72 04                	jb     8010742d <wmap+0x6d>
80107429:	39 d6                	cmp    %edx,%esi
8010742b:	77 16                	ja     80107443 <wmap+0x83>
        for (int i = 0; i < num_mappings; i++) {
8010742d:	83 c1 10             	add    $0x10,%ecx
80107430:	39 cf                	cmp    %ecx,%edi
80107432:	74 22                	je     80107456 <wmap+0x96>
            uint mapping_end = mappings[i].addr + mappings[i].length;
80107434:	8b 19                	mov    (%ecx),%ebx
80107436:	8b 51 04             	mov    0x4(%ecx),%edx
80107439:	01 da                	add    %ebx,%edx
            if ((new_addr >= mappings[i].addr && new_addr < mapping_end) || (new_addr + length >= mappings[i].addr && new_addr + length < mapping_end) || (mappings[i].addr >= new_addr && mappings[i].addr < new_addr + length) || (mapping_end >= new_addr && mapping_end < new_addr + length)) {
8010743b:	39 c2                	cmp    %eax,%edx
8010743d:	76 d1                	jbe    80107410 <wmap+0x50>
8010743f:	39 c3                	cmp    %eax,%ebx
80107441:	77 cd                	ja     80107410 <wmap+0x50>
                new_addr = PGROUNDDOWN(mapping_end) + PGSIZE;
80107443:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
        for (int i = 0; i < num_mappings; i++) {
80107449:	83 c1 10             	add    $0x10,%ecx
                new_addr = PGROUNDDOWN(mapping_end) + PGSIZE;
8010744c:	8d 82 00 10 00 00    	lea    0x1000(%edx),%eax
        for (int i = 0; i < num_mappings; i++) {
80107452:	39 cf                	cmp    %ecx,%edi
80107454:	75 de                	jne    80107434 <wmap+0x74>
80107456:	8b 75 f0             	mov    -0x10(%ebp),%esi
...
8010745c:	8d 56 01             	lea    0x1(%esi),%edx
8010745f:	c1 e6 04             	shl    $0x4,%esi
80107462:	8b 4d 14             	mov    0x14(%ebp),%ecx
80107465:	89 15 e0 64 14 80    	mov    %edx,0x801464e0
8010746b:	89 be 04 65 14 80    	mov    %edi,-0x7feb9afc(%esi)
80107471:	8b 7d 10             	mov    0x10(%ebp),%edi
80107474:	89 86 00 65 14 80    	mov    %eax,-0x7feb9b00(%esi)
8010747a:	89 be 08 65 14 80    	mov    %edi,-0x7feb9af8(%esi)
80107480:	89 8e 0c 65 14 80    	mov    %ecx,-0x7feb9af4(%esi)
    return new_mapping.addr;
}
80107486:	83 c4 04             	add    $0x4,%esp
80107489:	5b                   	pop    %ebx
8010748a:	5e                   	pop    %esi
8010748b:	5f                   	pop    %edi
8010748c:	5d                   	pop    %ebp
...
80107490:	8d 8a 00 00 00 a0    	lea    -0x60000000(%edx),%ecx
        return FAILED;
80107496:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
        if (addr < 0x60000000 || addr >= 0x80000000 || ((addr & (PGSIZE - 1)) != 0)) {
8010749b:	81 f9 ff ff ff 1f    	cmp    $0x1fffffff,%ecx
801074a1:	77 e3                	ja     80107486 <wmap+0xc6>
801074a3:	f7 c2 ff 0f 00 00    	test   $0xfff,%edx
801074a9:	75 db                	jne    80107486 <wmap+0xc6>
        for (int i = 0; i < num_mappings; i++) {
801074ab:	85 f6                	test   %esi,%esi
801074ad:	7e 6e                	jle    8010751d <wmap+0x15d>
...
801074b2:	89 75 f0             	mov    %esi,-0x10(%ebp)
        for (int i = 0; i < num_mappings; i++) {
801074b5:	31 db                	xor    %ebx,%ebx
            if ((addr >= mappings[i].addr && addr < mapping_end) || (addr + length >= mappings[i].addr && addr + length < mapping_end) || (mappings[i].addr >= addr && mappings[i].addr < addr + length) || (mapping_end >= addr && mapping_end < addr + length)) {
801074b7:	01 d7                	add    %edx,%edi
801074b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            uint mapping_end = mappings[i].addr + mappings[i].length;
801074c0:	89 d9                	mov    %ebx,%ecx
801074c2:	c1 e1 04             	shl    $0x4,%ecx
801074c5:	8b 81 00 65 14 80    	mov    -0x7feb9b00(%ecx),%eax
801074cb:	8b b1 04 65 14 80    	mov    -0x7feb9afc(%ecx),%esi
801074d1:	01 c6                	add    %eax,%esi
801074d3:	89 f1                	mov    %esi,%ecx
            if ((addr >= mappings[i].addr && addr < mapping_end) || (addr + length >= mappings[i].addr && addr + length < mapping_end) || (mappings[i].addr >= addr && mappings[i].addr < addr + length) || (mapping_end >= addr && mapping_end < addr + length)) {
801074d5:	39 f2                	cmp    %esi,%edx
801074d7:	73 04                	jae    801074dd <wmap+0x11d>
801074d9:	39 d0                	cmp    %edx,%eax
801074db:	76 33                	jbe    80107510 <wmap+0x150>
801074dd:	39 f8                	cmp    %edi,%eax
801074df:	77 04                	ja     801074e5 <wmap+0x125>
801074e1:	39 cf                	cmp    %ecx,%edi
801074e3:	72 2b                	jb     80107510 <wmap+0x150>
801074e5:	39 d0                	cmp    %edx,%eax
801074e7:	72 04                	jb     801074ed <wmap+0x12d>
801074e9:	39 f8                	cmp    %edi,%eax
801074eb:	72 23                	jb     80107510 <wmap+0x150>
801074ed:	39 ca                	cmp    %ecx,%edx
801074ef:	77 04                	ja     801074f5 <wmap+0x135>
801074f1:	39 cf                	cmp    %ecx,%edi
801074f3:	77 1b                	ja     80107510 <wmap+0x150>
        for (int i = 0; i < num_mappings; i++) {
801074f5:	83 c3 01             	add    $0x1,%ebx
801074f8:	39 5d f0             	cmp    %ebx,-0x10(%ebp)
801074fb:	75 c3                	jne    801074c0 <wmap+0x100>
801074fd:	8b 75 f0             	mov    -0x10(%ebp),%esi
80107500:	89 d0                	mov    %edx,%eax
80107502:	e9 52 ff ff ff       	jmp    80107459 <wmap+0x99>
80107507:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010750e:	66 90                	xchg   %ax,%ax
}
80107510:	83 c4 04             	add    $0x4,%esp
        return FAILED;
...
8010751c:	c3                   	ret    
        for (int i = 0; i < num_mappings; i++) {
8010751d:	89 d0                	mov    %edx,%eax
8010751f:	e9 35 ff ff ff       	jmp    80107459 <wmap+0x99>
...
80107530:	55                   	push   %ebp
    int found = 0;
    for (int i = 0; i < num_mappings; i++) {
80107531:	8b 0d e0 64 14 80    	mov    0x801464e0,%ecx
int wunmap(uint addr) {
80107537:	89 e5                	mov    %esp,%ebp
80107539:	53                   	push   %ebx
8010753a:	8b 5d 08             	mov    0x8(%ebp),%ebx
    for (int i = 0; i < num_mappings; i++) {
8010753d:	85 c9                	test   %ecx,%ecx
8010753f:	7e 77                	jle    801075b8 <wunmap+0x88>
80107541:	31 d2                	xor    %edx,%edx
80107543:	eb 0a                	jmp    8010754f <wunmap+0x1f>
80107545:	8d 76 00             	lea    0x0(%esi),%esi
80107548:	83 c2 01             	add    $0x1,%edx
8010754b:	39 ca                	cmp    %ecx,%edx
8010754d:	74 69                	je     801075b8 <wunmap+0x88>
        if (mappings[i].addr == addr) {
8010754f:	89 d0                	mov    %edx,%eax
80107551:	c1 e0 04             	shl    $0x4,%eax
80107554:	39 98 00 65 14 80    	cmp    %ebx,-0x7feb9b00(%eax)
8010755a:	75 ec                	jne    80107548 <wunmap+0x18>
            found = 1;
            // Shift all subsequent mappings one position towards the start
            for (int j = i; j < num_mappings - 1; j++) {
8010755c:	8d 59 ff             	lea    -0x1(%ecx),%ebx
8010755f:	39 d3                	cmp    %edx,%ebx
80107561:	7e 44                	jle    801075a7 <wunmap+0x77>
80107563:	81 c1 ff ff ff 0f    	add    $0xfffffff,%ecx
80107569:	c1 e1 04             	shl    $0x4,%ecx
8010756c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
                mappings[j] = mappings[j + 1];
80107570:	8b 90 10 65 14 80    	mov    -0x7feb9af0(%eax),%edx
            for (int j = i; j < num_mappings - 1; j++) {
80107576:	83 c0 10             	add    $0x10,%eax
                mappings[j] = mappings[j + 1];
80107579:	89 90 f0 64 14 80    	mov    %edx,-0x7feb9b10(%eax)
8010757f:	8b 90 04 65 14 80    	mov    -0x7feb9afc(%eax),%edx
80107585:	89 90 f4 64 14 80    	mov    %edx,-0x7feb9b0c(%eax)
8010758b:	8b 90 08 65 14 80    	mov    -0x7feb9af8(%eax),%edx
80107591:	89 90 f8 64 14 80    	mov    %edx,-0x7feb9b08(%eax)
80107597:	8b 90 0c 65 14 80    	mov    -0x7feb9af4(%eax),%edx
8010759d:	89 90 fc 64 14 80    	mov    %edx,-0x7feb9b04(%eax)
            for (int j = i; j < num_mappings - 1; j++) {
801075a3:	39 c8                	cmp    %ecx,%eax
801075a5:	75 c9                	jne    80107570 <wunmap+0x40>
            }
            num_mappings--; // Decrease the total number of mappings
801075a7:	89 1d e0 64 14 80    	mov    %ebx,0x801464e0
    }
    if (!found) {
    ...
    return SUCCESS;
801075ad:	31 c0                	xor    %eax,%eax
}
801075af:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801075b2:	c9                   	leave  
801075b3:	c3                   	ret    
801075b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801075b8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
        return FAILED;
...
801075d2:	c3                   	ret    
801075d3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801075da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

801075e0 <getpgdirinfo>:
...
801075e9:	8b 75 08             	mov    0x8(%ebp),%esi
    struct proc *curproc = myproc();
801075ec:	e8 8f c3 ff ff       	call   80103980 <myproc>
    if (curproc == 0) {
801075f1:	85 c0                	test   %eax,%eax
801075f3:	0f 84 99 00 00 00    	je     80107692 <getpgdirinfo+0xb2>
        return FAILED;
    }
    pdinfo->n_upages = 0;
801075f9:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
    pde_t *curr_pgdir = curproc->pgdir;
    pte_t *pte;
    uint va = 0x60000000;
801075ff:	bf 00 00 00 60       	mov    $0x60000000,%edi
    pde_t *curr_pgdir = curproc->pgdir;
80107604:	8b 58 04             	mov    0x4(%eax),%ebx
    int pdinfo_ind = 0;
80107607:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010760e:	eb 0e                	jmp    8010761e <getpgdirinfo+0x3e>
            cprintf("0x%x, 0x%x\n", va, P2V(PTE_ADDR(*pte)));
        ...
        va += PGSIZE;
80107610:	81 c7 00 10 00 00    	add    $0x1000,%edi
    for (int i = 0; i < MAX_UPAGE_INFO; i++) {
80107616:	81 ff 00 00 02 60    	cmp    $0x60020000,%edi
8010761c:	74 6a                	je     80107688 <getpgdirinfo+0xa8>
        pte = walkpgdir(curr_pgdir, (void*)va, 0);
8010761e:	83 ec 04             	sub    $0x4,%esp
80107621:	6a 00                	push   $0x0
80107623:	57                   	push   %edi
80107624:	53                   	push   %ebx
80107625:	e8 56 f4 ff ff       	call   80106a80 <walkpgdir>
        if (pte && (*pte & PTE_U)) {
8010762a:	83 c4 10             	add    $0x10,%esp
8010762d:	85 c0                	test   %eax,%eax
8010762f:	74 df                	je     80107610 <getpgdirinfo+0x30>
80107631:	f6 00 04             	testb  $0x4,(%eax)
80107634:	74 da                	je     80107610 <getpgdirinfo+0x30>
            pdinfo->n_upages++;
80107636:	83 06 01             	addl   $0x1,(%esi)
            cprintf("0x%x, 0x%x\n", va, P2V(PTE_ADDR(*pte)));
80107639:	8b 08                	mov    (%eax),%ecx
8010763b:	83 ec 04             	sub    $0x4,%esp
8010763e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107641:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
80107647:	81 c1 00 00 00 80    	add    $0x80000000,%ecx
8010764d:	51                   	push   %ecx
8010764e:	57                   	push   %edi
8010764f:	68 fb 81 10 80       	push   $0x801081fb
80107654:	e8 47 90 ff ff       	call   801006a0 <cprintf>
            pdinfo->va[pdinfo_ind] = va;
80107659:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            pdinfo->pa[pdinfo_ind] = V2P(*pte);
8010765c:	8b 45 e0             	mov    -0x20(%ebp),%eax
            pdinfo_ind++;
8010765f:	83 c4 10             	add    $0x10,%esp
            pdinfo->va[pdinfo_ind] = va;
80107662:	89 7c 96 04          	mov    %edi,0x4(%esi,%edx,4)
            pdinfo->pa[pdinfo_ind] = V2P(*pte);
80107666:	8b 00                	mov    (%eax),%eax
        va += PGSIZE;
80107668:	81 c7 00 10 00 00    	add    $0x1000,%edi
            pdinfo->pa[pdinfo_ind] = V2P(*pte);
8010766e:	05 00 00 00 80       	add    $0x80000000,%eax
80107673:	89 84 96 84 00 00 00 	mov    %eax,0x84(%esi,%edx,4)
            pdinfo_ind++;
8010767a:	83 c2 01             	add    $0x1,%edx
8010767d:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    for (int i = 0; i < MAX_UPAGE_INFO; i++) {
80107680:	81 ff 00 00 02 60    	cmp    $0x60020000,%edi
80107686:	75 96                	jne    8010761e <getpgdirinfo+0x3e>
    }
    return SUCCESS;
80107688:	31 c0                	xor    %eax,%eax
}
...
80107697:	eb f1                	jmp    8010768a <getpgdirinfo+0xaa>
80107699:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801076a0 <getwmapinfo>:

int getwmapinfo(struct wmapinfo *wminfo) {
801076a0:	55                   	push   %ebp
801076a1:	89 e5                	mov    %esp,%ebp
801076a3:	56                   	push   %esi
801076a4:	8b 4d 08             	mov    0x8(%ebp),%ecx
801076a7:	53                   	push   %ebx
    wminfo->total_mmaps = 0;
801076a8:	c7 01 00 00 00 00    	movl   $0x0,(%ecx)
    for (int i = 0; i < num_mappings; i++) {
801076ae:	a1 e0 64 14 80       	mov    0x801464e0,%eax
801076b3:	85 c0                	test   %eax,%eax
801076b5:	7e 46                	jle    801076fd <getwmapinfo+0x5d>
801076b7:	bb 00 65 14 80       	mov    $0x80146500,%ebx
801076bc:	31 d2                	xor    %edx,%edx
801076be:	66 90                	xchg   %ax,%ax
        wminfo->total_mmaps++;
801076c0:	83 c2 01             	add    $0x1,%edx
801076c3:	89 11                	mov    %edx,(%ecx)
        wminfo->addr[i] = mappings[i].addr;
801076c5:	8b 03                	mov    (%ebx),%eax
801076c7:	89 04 91             	mov    %eax,(%ecx,%edx,4)
        wminfo->length[i] = mappings[i].length;
801076ca:	8b 73 04             	mov    0x4(%ebx),%esi
        uint num_pages = mappings[i].length / PGSIZE;
801076cd:	85 f6                	test   %esi,%esi
801076cf:	8d 86 ff 0f 00 00    	lea    0xfff(%esi),%eax
        wminfo->length[i] = mappings[i].length;
801076d5:	89 74 91 40          	mov    %esi,0x40(%ecx,%edx,4)
        uint num_pages = mappings[i].length / PGSIZE;
801076d9:	0f 49 c6             	cmovns %esi,%eax
        if (mappings[i].length % PGSIZE != 0) {
801076dc:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
        uint num_pages = mappings[i].length / PGSIZE;
801076e2:	c1 f8 0c             	sar    $0xc,%eax
            num_pages++;
801076e5:	83 fe 01             	cmp    $0x1,%esi
801076e8:	83 d8 ff             	sbb    $0xffffffff,%eax
    for (int i = 0; i < num_mappings; i++) {
801076eb:	83 c3 10             	add    $0x10,%ebx
        }
        wminfo->n_loaded_pages[i] = num_pages;
801076ee:	89 84 91 80 00 00 00 	mov    %eax,0x80(%ecx,%edx,4)
    for (int i = 0; i < num_mappings; i++) {
801076f5:	3b 15 e0 64 14 80    	cmp    0x801464e0,%edx
801076fb:	7c c3                	jl     801076c0 <getwmapinfo+0x20>
    }
    return SUCCESS;
}
801076fd:	5b                   	pop    %ebx
...
80107716:	83 ec 0c             	sub    $0xc,%esp
    for (int i = 0; i < num_mappings; i++) {
80107719:	8b 35 e0 64 14 80    	mov    0x801464e0,%esi
int handle_pagefault(uint addr) {
8010771f:	8b 5d 08             	mov    0x8(%ebp),%ebx
    for (int i = 0; i < num_mappings; i++) {
80107722:	85 f6                	test   %esi,%esi
80107724:	7e 7a                	jle    801077a0 <handle_pagefault+0x90>
80107726:	31 d2                	xor    %edx,%edx
80107728:	eb 17                	jmp    80107741 <handle_pagefault+0x31>
8010772a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        if (addr >= mappings[i].addr || addr < mappings[i].addr + mappings[i].length) {
80107730:	03 81 04 65 14 80    	add    -0x7feb9afc(%ecx),%eax
80107736:	39 d8                	cmp    %ebx,%eax
80107738:	77 16                	ja     80107750 <handle_pagefault+0x40>
    for (int i = 0; i < num_mappings; i++) {
8010773a:	83 c2 01             	add    $0x1,%edx
8010773d:	39 f2                	cmp    %esi,%edx
8010773f:	74 5f                	je     801077a0 <handle_pagefault+0x90>
        if (addr >= mappings[i].addr || addr < mappings[i].addr + mappings[i].length) {
80107741:	89 d1                	mov    %edx,%ecx
80107743:	c1 e1 04             	shl    $0x4,%ecx
80107746:	8b 81 00 65 14 80    	mov    -0x7feb9b00(%ecx),%eax
8010774c:	39 d8                	cmp    %ebx,%eax
8010774e:	77 e0                	ja     80107730 <handle_pagefault+0x20>
            struct proc *curr_proc = myproc();
80107750:	e8 2b c2 ff ff       	call   80103980 <myproc>
80107755:	89 c7                	mov    %eax,%edi
            char *mem = kalloc();
80107757:	e8 24 af ff ff       	call   80102680 <kalloc>
8010775c:	89 c6                	mov    %eax,%esi
            if (mem == 0) {
8010775e:	85 c0                	test   %eax,%eax
80107760:	74 3e                	je     801077a0 <handle_pagefault+0x90>
                return 0;
            }
            int success = mappages(curr_proc->pgdir, (void *)addr, PGSIZE, V2P(mem), PTE_W | PTE_U);
80107762:	83 ec 0c             	sub    $0xc,%esp
80107765:	8d 80 00 00 00 80    	lea    -0x80000000(%eax),%eax
8010776b:	6a 06                	push   $0x6
8010776d:	50                   	push   %eax
8010776e:	68 00 10 00 00       	push   $0x1000
80107773:	53                   	push   %ebx
80107774:	ff 77 04             	push   0x4(%edi)
80107777:	e8 94 f3 ff ff       	call   80106b10 <mappages>
            if (success != 0) {
8010777c:	83 c4 20             	add    $0x20,%esp
            int success = mappages(curr_proc->pgdir, (void *)addr, PGSIZE, V2P(mem), PTE_W | PTE_U);
8010777f:	89 c2                	mov    %eax,%edx
                ...
                return 1;
80107781:	b8 01 00 00 00       	mov    $0x1,%eax
            if (success != 0) {
80107786:	85 d2                	test   %edx,%edx
80107788:	74 18                	je     801077a2 <handle_pagefault+0x92>
                kfree(mem);
8010778a:	83 ec 0c             	sub    $0xc,%esp
8010778d:	56                   	push   %esi
8010778e:	e8 2d ad ff ff       	call   801024c0 <kfree>
                return 0;
